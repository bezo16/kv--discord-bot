const data = {
  ...
  "Abhimanyu": "Theonly son of Arjuna and Subhadrā. He was a promising heir to the Kuru dynasty but died in the Battle of Kurukṣetra while still in his teens. He left his widow, Uttarā, pregnant with Parīkṣit.",
  "abhiras": "Adegraded tribe of nomadic cowherds. The gopas of Vraja are sometimes disparagingly called Abhiras even though they are actually proper vaiśyas.",
  ...
  "ācārya": "Onewho teaches by personal example. Ācāryas in the pure Vaiṣṇava line instruct people and initiate them into the Supreme Lord’s devotional service.",
  "acchā": "A common Hindi expression meaning, “I see,” or, “Is that so?”",
  "acchha": "good, ok, all right.",
  "acintya": "Inconceivable.",
  "acintya-bhedābheda-tattva": "LordCaitanya’s “simultaneously one and different” doctrine, which establishes the inconceivable, simultaneous oneness and difference of the Lord and His expansions.",
  ...
  "Adhiratha": "fosterfather of Karṇa. He was a charioteer by profession. He one day found the child Karṇa floating in the Ganges in a basket. His wife was barren and happily he took the child home and gave it to his wife.",
  ...
  "Adhokṣaja": "aname for the Supreme Personality of Godhead, who is beyond material sense perception, who is not perceivable by impure material senses.",
  ...
  "Aditi": "Dakṣa’soldest daughter, a wife of Kaśyapa. She gave birth to twelve sons, including the eleven principal demigods (such as Sūrya, Varuṇa, and Indra) and the Supreme Personality of Godhead Lord Vāmana.",
  "Ādityas": "Aditi’stwelve sons: Sūrya, Aryamā, Pūṣā, Tvaṣṭā, Savitā, Bhaga, Dhātā, Vidhātā, Varuṇa, Mitra, Indra, and Lord Vamana. They rule the universe as the principal demigods during the period of the current Manu, Vaivasvata.",
  "Advaita Prabhu": "see: Advaitācārya.",
  "advaita": "nondual; without differentiation.",
  "advaita-siddhānta": "theconclusion of the monists, namely, that the Absolute Truth and the individual living entity are separate in the material state, but that when they are spiritually situated there is no difference between them.",
  "advaita-vāda": "the philosophy of absolute oneness taught by Śaṅkarācārya, and whose conclusion is advaita-siddhānta.",
  "Advaita-vādīs": "Proponentsof the impersonal philosophy of “oneness,” which claims that the Absolute Truth, one without a second, is ultimately formless and that whatever has name and form is an illusion falsely imposed on that impersonal Absolute Truth. See Māyāvādīs.",
  ...
  "Āgamas": "See tantras.",
  "Agastya Muni": "agreat sage who authored many Vedic hymns and writings on Āyurvedic medicine. The son of Mitra and Varuṇa, he was born from a water jar. Once he swallowed the ocean and forced the Vindhya mountain range to prostrate itself before him.",
  "agastya": "the mind.",
  ...
  "Agnistoma": "asacrifice performed by a person who wants go to heaven. A minimum of sixteen priests are required for this sacrifice, which lasts five days.",
  ...
  "ahaṅkāra": "Falseego, the first and most subtle of the separated elements of material creation. By its influence, conditioned souls assume temporary material identities.",
  "ahiṁsa": "Nonviolence.",
  "ahiṁsā": "nonviolence.",
  "Airāvata": "The elephant who carries Lord Indra. Airāvata appeared from thechurning of the Milk Ocean and has four tusks and seven trunks.",
  ...
  "ajam": "unborn.",
  "Ajāmila": "A brāhmaṇawhose attraction to a prostitute led him into sinful life but who was saved by his deathbed cries for his son Nārāyaṇa, cries that brought themessengers of Lord Nārāyaṇa to stop those of Yamarāja from dragging himto hell.",
  ...
  "ajowan seeds": "tiny, light-brown spice seeds closely related to caraway and cumin with a very strong, thyme and oregano flavour. Ajowan, Carum ajowanis used in many North Indian savoury dishes, especially in fried snacks. Ajowan aids digestion and is to relieve stomach problems. The seeds keep indefinitely are available from Indian Middle Eastern grocers.",
  "akāma-bhakta": "one who serves the Lord without material motive.",
  "akarma (naiskarma)": "actionfor which one suffers no reaction because it is performed in Kṛṣṇa consciousness; free from material desire; one who is desireless.",
  "ākāśa": "sky.",
  ...
  "Āmalakī": "atree that Nārada Muni brought from the spiritual world to the material realm to please the Supreme Lord. Its fruits are very rich in vitamin C.",
  ...
  "Ambālikā": "Youngestof the daughters of the King of Kāśi. She was married to Vicitravīrya. When Vicitravīrya died early, she begot Pāṇḍu by the great sage Vyāsa. (Ādi Parva in Mahābhārata)",
  "Ambarīṣa Mahārāja": "a great devotee-king who perfectly executed all nine devotional practices (hearing, chanting, etc.).",
  "Ambarīṣa": "Asaintly Vaiṣṇava king famous for using all his resources and bodily activities in devotional service to the Supreme Lord. Angered by a minoraccidental fault of the king’s, the sage Durvāsā tried to kill him, butLord Viṣṇu sent the Sudarśana disc to attack Durvāsā, who finally had to beg the king’s forgiveness.",
  ...
  "amchoor": "a tan coloured powdermade from grinding small sun-dried green mangoes. Amchoor is used in North Indian dishes to give a slightly sour, pungent taste. It is a predominant flavour in the spice blend called chat masala and is available at all Indian grocery stores.",
  ...
  "Ananta": "(AnantaŚeṣa, Śeṣa Nāga) 1. An expansion of God who appears as a serpent with thousands of heads and who serves as the bed of Lord Viṣṇu. Ananta Śeṣa holds all the planets of the universe on His hoods and constantly sings the glories of Viṣṇu from all His mouths. 2. Unlimited.",
  "ananta": "unlimited.",
  "Ananta-caturdaśī": "date of the yearly festival commemorating the passing away of Haridāsa Ṭhākura.",
  "Ananta-Śeṣa": "anincarnation of the Supreme Lord in the form of His thousand-headed serpent, on which Viṣṇu rests, and who sustains the planets on His hoods.",
  ...
  "Aniruddha": "Ason of Pradyumna and grandson of Kṛṣṇa. Aniruddha’s eternal consort, Ūṣā, sequestered him in the palace of her father, Bāṇa, where Aniruddha was captured and had to be rescued by Kṛṣṇa, Balarāma, and the Yādava army. He appears in Dvārakā and Mathurā as the fourth of the original quadruple vyūha expansions of the Supreme Lord, and He again expands from Lord Nārāyaṇa in Vaikuṇṭha, in the second quadruple, as theruler of intelligence.",
  ...
  "antipasto": "alight starter or an appetizer served before an Italian meal. It can also be used as a light snack. Vegetables and salads (served raw or lightly cooked), make delicious antipasto, as do simple hot dishes, fried breads (crostini), or miniature pizzas.",
  ...
  "Anuvinda": "aKing of Avanti. He and his brother, Vinda, were the brothers of Mitravindā, who was married to Lord Śrī Kṛṣṇa. Both brothers were inimical to Lord Kṛṣṇa and were killed by Arjuna. (Droṇa Parva in Mahābhārata)",
  "anyābhilāṣitā-śūnyam": "Śrīla Rūpa Goswāmī’s definition of pure devotional service as beingfree from any other desire than the desire to server Kṛṣṇa.",
  ...
  "ārati": "Astandard ceremony of worship with offerings of lamps, fans, incense, fiowers, bathing water, and other items. Its origin is the custom of greeting a guest to one’s home at night (ā-rātrikam) with a lamp.",
  ...
  "Arcā-vigraha": "anauthorized form of God manifested through material elements, as in a painting or statue of Kṛṣṇa worshiped in a temple or home. Actually present in this form, the Lord accepts worship from His devotees.",
  ...
  "arghya": "Watermixed with auspicious substances and offered to an honored guest, either sprinkled on their head or offered into their hands.",
  ...
  "arjuna trees": "Two trees of the arjunaspecies that stood in the courtyard of Nanda Mahārāja until Kṛṣṇa uprooted them. Formerly sons of Kuvera, they had been cursed to stand astrees until delivered by Kṛṣṇa.",
  "Arjuna": "Thethird of the five Pāṇḍava brothers. A great bowman, he figured prominently in winning the Kurukṣetra battle, with Kṛṣṇa driving his chariot. It was to Arjuna that Kṛṣṇa spoke the Bhagavad-gītā just before the battle.",
  "arka": "A large-leafed plant whose leaves are used in sacred rituals.",
  "arrowroot": "a very fine white starch derived from the rootstock of the South American tropical plant Maranta arundinacea.Arrowroot is used much like cornflour in sauces, except that it is a non-grain flour and thickens at a lower temperature. It is also used as abinding agent. It is available at most supermarkets or grocers.",
  ...
  "artha-vāda": "The statements of śrutithat praise, encourage, or explain rather than enjoin ritual duties. The term is sometimes used perjoratively to indicate flowery praise thatcannot be taken literally.",
  ...
  "Aryan": "afollower of Vedic culture. A person whose goal is spiritual advancement. He truly knows the value of life and has a civilization based on spiritual realization.",
  ...
  "Aśvatthāmā": "Theson of Droṇācārya who fought against the Pāṇḍavas at Kurukṣetra. In a desperate act of revenge at the end of the battle, he killed the five young sons of the Pāṇḍavas in their sleep and tried to kill the last remaining heir, Parīkṣit, in his mother’s womb.",
  "Aṣvatthāmā": "theson of Droṇa. He was a friend of Duryodhana and fought on his side during the Kurukṣetra battle. He lived through the battle of Kurukṣetra,but was cursed by Lord Śrī Kṛṣṇa. He killed the five sons of Draupadī when they were awakening from sleep and attempted to kill Parīkṣit when he was in the womb of Uttarā.",
  ...
  "Atharva Veda": "one of the four Vedas,the original revealed scriptures spoken by the Lord Himself, consistingprimarily of formulas and chants designed to counteract the effects of disease and calamity.",
  ...
  "Atri Ṛṣi": "oneof the seven great sages born directly from Brahmā;. He is the husband of Anusūyā and father of the Lord’s incarnation Dattātreya. He contributed to the knowledge of astronomy.",
  "Atri": "AVedic sage, born of the mind of Brahma. When Atri prayed to the Supremefor a son like Him, but without a clear idea of who the Supreme is, theLords Viṣṇu, Brahmā, and Śiva all agreed to become his sons as Dattātreya, Soma, and Durvāsā.",
  "atta flour": "also known as chapati flour,this low-gluten flour is derived from a strain of soft wheat popular throughout India. The entire wheat kernel, including the bran, germ, andendosperm, is ground very finely making a nutritious flour. Atta flour is suitable for all Indian flatbreads, such as pooris, chapatis, and parathas. Doughs made with attaflour are velvety smooth, knead readily, and respond easily to shaping and rolling. Atta flour is available from Indian and Asian grocery stores.",
  ...
  "Avanti": "Oneof the seven sacred cities that can bestow liberation. Kṛṣṇa’s spiritual master, Sāndīpani Muni, resided there, and Kṛṣṇa and Balarāma lived there as students in his āśrama. Avanti has become the modern city of Ujjain, in the western part of Madhya Pradesh.",
  "avara": "material.",
  ...
  "Ayodhyā": "Thecapital of the Kośala kingdom, inherited by Lord Rāmacandra from His ancestors. It is located in south-central Uttar Pradesh. The original Ayodhyā in the eternal kingdom of God lies above the other Vaikuṇṭha worlds and below Goloka Vṛndāvana.",
  "Ayodya": "a city inNorth India, capital of the kings of the Ikavaku (solar) dynasty. Today, it is till the chief Holy City of Lord Rama's devotees.",
  "ayoga": "See: viyoga.",
  "Ayukta": "the ecstatic condition of not having yet met one’s lover.",
  "āyurveda": "thesection of the Vedas which expounds the Vedic science of medicine delivered by Lord Dhanvantari, the incarnation of the Supreme Lord as a physician. He was born out of the ocean of milk when it was churned by the demons and demigods in the Satya-yuga. He expounded on the three categories of medicine.",
  ...
  "Babhruvāhana": "ason of Arjuna by Citrāṇgada, the daughter of the King of Maṇipur. Babhruvāhana engaged in battle with his father over the sacrificial horse. At that time Babhruvāhana killed Arjuna. Arjuna was later broughtback to life by Ulūpī, another wife of Arjuna.",
  ...
  "Balarāma (Baladeva)": "thefirst plenary expansion of the Supreme Personality of Godhead, Lord Kṛṣṇa. He appeared as the son of Rohiṇī and elder brother of Lord Kṛṣṇa.Also known as Balabhadra or Baladeva, present as one of the three Jagannātha deities.",
  "Balarāma": "(Baladeva, Balabhadra) Kṛṣṇa’s elder brother, and His first plenary expansion, son of Vasudeva and Rohiṇī.",
  "Bālhīka": "ason of Pratīpa. He had two brothers Devāpi and Śantanu. He was killed by Bhīmasena during the Kurukṣetra war. (Droṇa Parva in Mahābhārata)",
  "Bali Māhāraja": "theking of the demons who gave three paces of land to Vamanadeva, the dwarf incarnation of Lord Viṣṇu, and thereby became a great devotee by surrendering everything to Him.",
  "Bali": "Kingof the Daitya demons, son of Virocana, and grandson of the great Vaiṣṇava Prahlāda. When Lord Vāmana tricked Bali into donating three paces of land and then with two steps covered the universe, Bali achieved perfection by surrendering everything he had to the Lord.",
  "bāliśa": "innocent and foolish like a child.",
  "Ballal Sen": "Kingof Bengal in the 12th century. He was the son of King Vijaya Sen, the founder of Navadvīpa. Ballal Sen's son was Laksman Sen, the sponsor of Jayadeva Gosvāmi, the author of Gītā-govinda.",
  "Balvala": "Ademon who disturbed the sacrifices of sages in the Naimiṣa forest. Theyappealed for help to Lord Balarāma, and the Lord killed him.",
  "bālya": "Childhood.",
  "bamboo shoots": "thetender, inner part of the young shoots of the bamboo tree. They are used as an ingredient in Chinese, Japanese, and South East Asian dishes.The best quality bamboo is the first growth of shoots that sprout earlyin the new year and is known as winter bamboo. Fresh bamboo shoots are more or less unavailable in the West. Substitute canned bamboo shoots, available at any Asian grocer.",
  "Bāṇa": "(-asura)A thousand-armed demon, son of Bali. He was a favored devotee of Lord Siva’s. When Bāṇa’s daughter Ūṣā hid Kṛṣṇa’s grandson Aniruddha in Bāṇa’s palace, the demon arrested Aniruddha, and a battle ensued betweenKṛṣṇa and Lord Śiva. Defeated, Lord Śiva begged Kṛṣṇa to spare Bāṇa’s life. Kṛṣṇa then severed all but four of Bāṇa’s arms and blessed him to become an eternal associate of Śiva.",
  ...
  "Bhagadatta": "theKing of Prāgjyotiṣapura, and the son of Narakāsura or Bhaumāsura. He was killed by Arjuna during the Kurukṣetra war. (Droṇa Parva in Mahābhārata)",
  "bhagavad-bhakti": "Devotional service to the Supreme Lord.",
  "Bhagavad-gītā": "Theessential teachings on progressive spiritual life and pure devotion to the Supreme Lord spoken by the Supreme Lord Himself, Kṛṣṇa, to His friend Arjuna at Kurukṣetra in the last moments before the great battle.Vyāsadeva included the Bhagavad-gītā in the Bhīṣma-parva of the Mahābhārata.",
  ...
  "Bhāgavata-dharma": "thescience of devotional service to the Supreme Lord; the religious principles enunciated by the Lord; the eternal function of the living being.",
  ...
  "bhajana": "Lovingdevotional service to the Supreme Lord, performed favorably and free from the selfish motives of profit and liberation; a devotional hymn.",
  ...
  "bhakti-latā": "Lit.,“the creeper of devotional service.” A term used to liken the stages ofa devotee’s growth in devotional service to the growth of a creeper growing upward.",
  ...
  "Bhaktivedanta Institute": "Anorganization within ISKCON which conducts scientific research and education in accordance with the Gauḍīya Vaiṣṇava philosophy.",
  "Bhaktivedanta": "Atitle conferred upon Śrīla Prabhupāda by the Gauḍīya Maṭh, meaning “onewho has understood that the conclusion of Vedic scripture is bhakti (devotional service).”",
  ...
  "Bharata Mahārāja": "anancient king of India and a great devotee of the Lord from whom the Pāṇḍavas descended. The son of Mahārāja Duṣyanta who renounced his kingdom and family at an early age. He became very advanced in spiritualpractice, but later became attached to a pet deer causing him to take birth as a deer. In his next life, as Jaḍa Bharata, he attained spiritual perfection.",
  "Bharata Muni": "An ancient sage, author of the Nāṭya-śāstra, a standard textbook on drama and poetry.",
  "Bharata": "1.The second brother of Lord Rāmacandra. When Bharata’s mother, Kaikeyi, obliged her husband to send Rāma into exile and give the throne to Bharata instead, Bharata placed Rāma’s shoes on the throne and ruled as His representative until Rāma returned. 2. The eldest son of Ṛṣabhadeva.He was close to achieving pure love of God but became attracted to a helpless deer and so himself had to be born a deer. Then once again he was born as the seemingly dull brāhmaṇa Jaḍa Bharata. In this third lifehe instructed King Rahūgana and achieved ultimate perfection. 3. The son of Duṣmanta (Duṣyanta) and Śakuntalā.",
  ...
  "bhedābheda": "Thedoctrine of simultaneous difference and nondifference between God and His energies. Lord Caitanya Mahāprabhu taught a version of this philosophy qualified as acintya ( “inconceivable”).",
  "Bhīma": "(-sena)The second and strongest of the five Pāṇḍava brothers, a great club fighter, voracious eater, and intolerant punisher of wrongdoers. In the Battle of Kurukṣetra he fulfilled his vow to kill Duryodhana and all theKaurava brothers.",
  ...
  "Bhubaneswar": "aholy place in the district of Puri, Orissa, that is sacred to Lord Śivaand that was visited by Lord Caitanya. It is glorified in detail in theSkanda Purāṇa.",
  ...
  "Bhūriśrava": "oneof the three sons of Somadatta, a King of the Kuru dynasty. He was killed by Sātyaki during the great Kurukṣetra battle. (Droṇa Parva in Mahābhārata)",
  "bhūti": "opulence.",
  ...
  "Bila-svargas": "Thesubterranean heavenly planets, where specially empowered demons and other creatures enjoy exceptional power, health, and opulence, unaware that after a fixed duration of life they too will die.",
  ...
  "Birnagar": "atown just south of Krishnanagar in the West Bengal district of Nadia. In ancient times the Ganges flowed past this town making it a prosperousriver port. Once, the prince Srimanta Sandagar was sailing his fleet ofships up the Ganges to Birnagar and a violent storm arose. To save himself and his fleet, he prayed to Ulācaṇḍi, a wife of Lord Śiva. The fleet was saved, and the prince instituted her worship atthis site. The town of Birnagar was thus also known as Ulā-grāma, the birthplace of Ṭhākura Bhaktivinoda.",
  "biryani": "mild fancy rice, sometime with a sauce.",
  "black beans": "Soyabeans fermented with malt and salt. They have a strong, salty flavour. Dry in texture, they keep for a long time in the refrigerator. They are popular in Chinese and Indonesian cooking, especially as the basis for black bean sauce. They're available at Chinese and South East Asian grocers.",
  ...
  "brahma-jyoti": "Thespiritual effulgence of the Supreme Lord’s body. It pervades the space between the spiritual planets of the eternal kingdom of God, and it is conceived of as His impersonal aspect. Those who achieve impersonal liberation enter it, apparently losing their personal identities.",
  ...
  "Brahma-vaivarta Purāṇa": "one of the eighteen Purāṇas. Itcontains prayers and invocations addressed to Lord Śrī Kṛṣṇa, as well as descriptions of His transcendental pastimes with Srīmatī Rādhārāṇī and the other cowherd girls of Vṛndāvana.",
  ...
  "Brahmajyoti": "theimpersonal bodily effulgence emanating from the transcendental body of the Supreme Lord Kṛṣṇa, which constitutes the brilliant illumination of the spiritual sky.",
  ...
  "Brajmandal (Vraja-mandala)": "Thecircular area which encompasses Braj and designated by the pilgrimage path through the area’s sacred sites, each a scene of one of Krsna’s exploits.",
  ...
  "Bṛhaspati": "Thespiritual master of Indra and the demigods, and ruler of the planet Jupiter. He is a son of the sage Aṅgirā and grandson of Brahmā. His son is Uddhava, the great devotee of Kṛṣṇa.",
  ...
  "buckwheat": "Buckwheatis not a grain in the botanical sense, as it is related to dock and rhubarb, although some cookbooks classify it as such. Native to China, Nepal, and Siberia, it is rich in iron and contains 11% protein and almost the entire range of B-complex vitamins. Buckwheat is available inthe form of the whole seeds, called groats, finely cracked groats, called grits roasted whole groats, called kasha; and flour. Buckwheat is popular in Russian and Jewish cooking. It is available at health food stores and specialty grocers.",
  "Buddha": "incarnationof Kṛṣṇa, the founder of Buddhism who lived during the 5th century B.C., and appeared to bewilder atheists and dissuade them from performing unnecessary animal sacrifices.",
  ...
  "bulgur wheat": "agrain product made by par-boiling and drying whole wheat kernels and crushing them into various sizes. Bulgur is popular in Middle Eastern cuisine, especially in the famous tabbouleh salad. It has a chewytexture and a pleasant nutty taste, and is rich in protein calcium, phosphorus and iron. Bulgur wheat is available at health food shops and Middle Eastern grocers.",
  ...
  "Caitanya Mahāprabhu, (1486-1534)": "LordKṛṣṇa in the aspect of His own devotee. He appeared in Navadvīpa, West Bengal, and inaugurated the congregational chanting of the holy names ofthe Lord to teach pure love of God by means of saṅkīrtana. Lord Caitanya is understood by Gauḍīya Vaiṣṇavas to be Lord Kṛṣṇa Himself.",
  "caitanya": "living force.",
  "Caitanya-caritāmṛta": "translatedas “the character of the living force in immortality,” it is the title of the authorized biography of Lord Caitanya Mahāprabhu written in the late sixteenth century and compiled by Śrīla Kṛṣṇadāsa Kavirāja Gosvāmī,presenting the Lord’s pastimes and teachings. Written in Bengali, with many Sanskrit verses as well, it is regarded as the most authoritative book on Lord Caitanya's life and teachings.",
  ...
  "cakravāka": "Avariety of duck, legendary lovers who must sleep apart at night and forever call to one another, “Cakava, may I come to you?” “No, Cakavī.”",
  ...
  "cakravyūha": "a formation of soldiers in the form of a cakra.This formation was considered impenetrable, and only the most capable warriors could penetrate it. Abhimanyu was killed while fighting in thisformation. His father, Arjuna, taught him how to enter, but he did not know how to exit the gigantic formation.",
  "cāmara": "Afan made from the hairs of a yak’s tail, usually bleached white. Used in worship and the attendance of kings, it also has the practical purpose of driving away flies.",
  ...
  "camphor": "a pure white crystalline powder derived from steam of the camphor tree, Cinnamomum camphera,which in China and India. It is used in tiny amounts to flavour at someIndian grocers and pharmacies. Indian milk sweets and puddings. It is available regular Indian groceries.",
  "Cāṇakya Paṇḍita": "A legendary advisor to the Hindu king Chandragupta.",
  "cañcalā": "Flickering, unsteady.",
  "Caṇḍakauśika": "a muniwho blessed King Bāhadratha, the King of Magadha, with a child. The child was born in two halves from each of the King’s queens. The two halves were thrown in the forest where they were joined by a witch namedJara. The child was later named Jarāsandha.",
  "caṇḍāla": "The most degraded class of man, an outcaste.",
  "candana": "Sandalwood, which may be ground into a cooling paste.",
  "Candana-yātrā": "atwenty-one day festival held throughout India in the summer season. During Candana-yātrā devotees anoint the Deities of the Lord with shooting sandalwood paste.",
  ...
  "candrāyaṇa": "Theaustere practice, often prescribed as atonement for major transgressions, of restricting one’s eating for one month by taking onlyone handful of food the first day, increasing one handful more each dayfor two weeks, and then again decreasing by a handful a day for the second two weeks.",
  "cannelini beans": "the long, white cannelini beans are probably used more than any other dried beans in Italian dishes. They resemble dried white haricot (navy) beans, althoughthey are smaller. Soaked and boiled in water until soft they feature inmany vegetable dishes and soups",
  ...
  "caraṇāmṛta": "Thewater that has bathed the feet of the Supreme Lord or His devotee. One honors caraṇāmṛta, normally collected after the daily worship of the Deity, by sipping it and sprinkling it on one’s head.",
  ...
  "cardamom": "the aromatic seeds of the fruit of the tropical plant Elettaria cardamomum,a member of the ginger family which grows in the moist tropical regionsof South India and Śrī Lanka. Cardamom is the world's third most costlyspice, topped only by saffron and vanilla. The odour and flavour of cardamom is quite pronounced",
  "Carlyle, Thomas (1795-1881)": "aScottish historian and social critic who was an important philosophicalmoralist of the early Victorian age. He was opposed to empiricism, mechanism and materialism.",
  ...
  "catur-vyūha": "The principal expansions of the Supreme Lord in Vaikuṇṭha. The first four vyūhasare Vāsudeva, Saṅkarṣaṇa, Pradyumna, and Aniruddha. The original Vāsudeva and Saṅkarṣana are Kṛṣṇa and Balarāma as They appear in Mathurāand Dvārakā, and the original Pradyumna and Aniruddha are Kṛṣṇa’s firstson and grandson.",
  "Caturdaśī": "the fourteenth day of the waxing and waning moon.",
  "cāturmāsya": "thefour months of the rainy season in India (approximately July, August, September, and October). During this period, there are certain rules andregulations which are strictly followed to decrease sense enjoyment andincrease remembrance of the Lord.",
  ...
  "Channing, William Ellery (1780-1842)": "anAmerican theologian, founder of the Unitarian movement in New England. He believed in both rationality and mysticism. He concluded that in order for man to have a relationship with God He must be a person.",
  "chapati flour": "made from ground whole wheat. See: Atta.",
  "chapati": "A whole-wheat, griddle-baked flatbread.",
  "chappals": "sandals.",
  "chat masala": "atraditional companion to freshly-cut fruit in Indian cuisine. This lightbrown spice blend contains a number of ingredients, notably black salt, mango powder, and asafoetida. Sprinkled on fruit with a few drops of fresh lime juice, it makes a deliciously different dessert. Availablefrom Indian grocery stores.",
  "chataka": "Sparrow.",
  "chaukidar (chowkidar)": "night watchman; guard.",
  "chaukidar": "A security guard.",
  "chelā": "Disciple.",
  "chervil": "a close relative of cow parsley, lacy-leaved garden chervil (Anthriscus cerefoliumlisan)annual plant mainly cultivated in France as a kitchen herb. Its flavouris delicate and less robust than parsley, with the distinctive aroma ofanise. It is used raw, fresh, chopped, or broken into tiny sprigs. It is generally not cooked, but sometimes it is added to a dish just beforeserving. Chervil can be grown without difficulty in almost any garden or window box, or can be purchased at, or ordered from, well-stocked specialty greengrocers.",
  ...
  "chili oil": "afiery hot oil used in Chinese cooking. To make your own chili oil, stir-fry 3 or 4 dried red chilies in a few tablespoons of oil over moderate heat for 3 minutes. Strain the oil and use as required. Alternatively, chili oil can be purchased at any Chinese or South East Asian grocer.",
  ...
  "chilies, green": "theunripe green pods of various chili peppers are available in the marketsof most hot countries. Choose firm, green specimens. Fresh green chilies have an advantage over dried chilies, as they impart a deliciousflavour as well as heat. The seeds are the hottest part, and often a recipe calls for removing the seeds to tame the heat of the chili. Greenchilies are indispensable in Indian, Mexican, Indonesian, and Italian dishes. Fresh chilies are also nutritious, being rich in vitamins A and C. They also stimulate sluggish digestion. Fresh green chilies are available at most greengrocers and supermarkets.",
  "choko": "Usedin Mexican, Chinese, and Indonesian cooking, this delicate, pale-green,pear-shaped vegetable, which is related to the gourd family, originallycame from Mexico, where it is known as chayote. When buying chokos,look for young tender ones with pale, green, almost translucent skin. The spikes on the skin should be short and soft. Chokos add a subtle flavour and an apple-like texture to any dish.",
  ...
  "choy boh": "Preservedturnips, used in Chinese and Japanese cooking. Sold ln small packets, they are not expensive and will keep for a long time in the refrigerator. Preserved turnips impart a pleasant, slightly salty flavour to vegetable dishes and savouries. They're available at Asian grocery stores.",
  "choy sum": "although this plant, also known as Rape (its seeds are the source of Rapeseed oil) is grown in various parts of the world, it is used extensively in Chinese and Japanese cuisine as a vegetable. It is delicately flavoured, with yellowflowers, succulent green stalks, and small brightgreen leaves branchingfrom a central stem. This attractive vegetable is available from Chinese grocers all year round.",
  ...
  "Citraketu": "Asonless king at last blessed with a son, a son who died in infancy. Enlightened by Nārada, Citraketu became spiritually advanced, but he unintentionally insulted Lord Śiva and was cursed by Śiva’s consort. Thus he took his next birth as the great demon Vṛtra.",
  ...
  "Citrasena": "aGandharva leader who was a friend of Arjuna and a son of Viśvā-vasu. Hereceived a weapon of fire from Arjuna, and helped the Pāṇḍavas when Duryodhana tried to embarrass them at Dvaitavana.",
  "Citravarma": "one of the one hundred sons of Dhṛtarāṣṭra. He was killed by Bhīma. (Droṇa Parva in Mahābhārata)",
  "citric acid": "Powderedcitric acid crystals can be used as a souring agent preparing dishes where moisture must be avoided. It is also effective in curdling milk when making Home-made Curd Cheese (panir). These sugar-like white crystals are available at Indian grocery stores, supermarkets, and chemist shops.",
  "cloves": "the dried nail-shaped buds from the evergreen tree Eugenia aromatica.Clove trees are neat evergreens with aromatic pink Coriander buds. These buds, when hand picked and dried, turn reddish brown to become thecloves with which we are familiar.  Good cloves should have a strong, pungent, sweet aroma and flavour and should be well formed, plump, and oily. Cloves have diverse uses in different cuisines of the world, beingused for cakes, tarts and pastries, fancy rice dishes, soup stocks, sweet cooked fruits, and in various spice blends, including some North Indian garam masalas. Cloves are available at supermarkets and Indian grocery stores.",
  "coconut cream": "anunsweetened, fatty coconut product sold in blocks in Asian and Western supermarkets. Imparting a rich texture and coconut flavour, it is used in varieties of sweet and savoury Indonesian, Thai, and occasionally Indian dishes.",
  "coconut milk": "known as santanin Indonesian cooking, this creamy white liquid with a fresh, coconut flavour is extracted from fresh coconut pulp and is used in varieties ofSouth East Asian and Indonesian dishes. It is available in cans from supermarkets and Asian grocers.",
  "coconut oil": "extractedfrom coconut 'meat', this oil is solid white fat at room temperature but clear when heated. It is used extensively in South Indian cuisine.",
  "coconut": "the coconut palm, Cocos nuciferais grown on tropical coasts all over the world and is the source of many products. Most important are the nuts (technically called drupes inthis case). When coconuts are picked green, one can extract their sweetjuice as a beverage. The pulp inside is used in many South Indian savoury dishes. When coconuts ripen on the tree, the picked fruits yieldmoist, white “meat”, which is excellent in varieties of vegetable dishes, savouries, rice dishes, sweets, chutneys, and beverages, especially in Indian and South-East Asian cuisme. Dried coconut is dessicated and is familiar in Western cuisine as an ingredient in sweetsand cakes. When a recipe calls for fresh coconut, dried dessicated coconut is a poor substitute. Fresh coconuts are easily available in tropical areas and can even be found for sale far from their place of origin. These will be suitable as long as they are still full of juice and have no cracks or signs of mould around their “eyes”. Once cracked open, separated from their husk, and peeled, fresh coconut can be sliced, grated, shredded, stored in the refrigerator for several days, or frozen.",
  "coriander leaves, fresh": "the fresh leaves of the hardy annual plant Coriandrum sativum.Fresh coriander is one of the most commonly used flavouring herbs in the world, certainly on par with parsley. It is found in markets throughout the Middle East, China, South East Asia, India, and South andCentral America. Bunches of coriander can be recognized by their smell and their fan-like lower leaves and feathery upper ones. Also known as cilantro, Chinese Parsley, and har dhania,fresh coriander is a zesty and delicious addition to many varieties of the world's cuisines. Its unique warm-bodied taste is found in Indian vegetable dishes, dals, savouries, and fresh chutneys. It also makes a very beautiful garnish. Purchase fresh coriander from Oriental and Latin American grocers or well-stocked produce markets and greengrocers.",
  ...
  "corn oil": "Extractedfrom maize, or corn, it is a light oil and one of the most unsaturated of grain oils. It can be used as an alternative to olive oil as a salad dressing ingredient, and since it has a high smoking point, it is an excellent frying oil.",
  "cornflour": "When I mention cornflour in this book, I am referring to what Americans call “cornstarch”, and not to the flour milled from corn. Cornflour, sometimes referred to as wheat starch, is the dry white powdered starch remaining when the protein has been removed from wheat flour. It is usedin many cuisines, especially Chinese, as a thickener for sauces. It is available from any grocer or supermarket.",
  ...
  "curd cheese (Panir)": "thesimplest type of unripened fresh cheese, produced by adding an acidic curdling agent to boiled raw milk. This versatile food ingredient is popular in all varieties of Indian cuisine, and it can also be used as asubstitute for tofu, feta, or farmer's cheese. It is high in protein, has a soft consistency, and is sweeter and creamier than tofu.It can be cubed and deep-fried, and added to moist vegetable dishes andrice dishes, crumbled into salads, kneaded and rolled into smooth balls, and made into confectionery.",
  ...
  "daikon radish": "thislarge white radish is commonly grown in Japan. It is eaten cooked or raw, and is also grated and pickled. Pickled daikon radish is called Takuwan and is eaten as a condiment with savouries such as Japanese Rice Balls (Onigiri).",
  ...
  "daivī prakṛti": "see: yogamāyā.",
  "Dakṣa": "Oneof the main Prajāpatis, the forefathers of the various species of life.He was a mind-born son of Brahmā. Of his sixteen daughters, thirteen married Kaśyapa, and the youngest, Satī, married Lord Śiva.",
  ...
  "dal": "thename for any type of dried bean lentil, or pea in India. It is also thename for thick gravy-like or thin soup-like dishes prepared from these beans, lentils, or peas. Most raw dal in India is split. (brown lentils, yellow and green split peas, whole mung beans, arhar dal, chana dal, green split peas, and urad dal).",
  ...
  "Daśaratha": "Thefather of Lord Rāmacandra. Having promised two boons to one of his wives, he was bound to his word when she demanded that Rāma be exiled tothe forest and her son enthroned instead. Daśaratha granted her requestbut soon died from the anguish of separation from Rāma.",
  "Daśārha": "the founder of one branch of the Yadu clan.",
  "Daśāśvamedha-ghāṭa": "Thesacred bathing place at Prayāga where the Deity Mādhava is worshiped. At this place Lord Caitanya Mahāprabhu instructed Rūpa Gosvāmī.",
  ...
  "Dattātreya": "Anincarnation of Lord Viṣṇu who appeared as one of the sons of Atri Muni.His instructions to King Yayāti are recorded in the Eleventh Canto of Śrīmad-Bhāgavatam, chapters 7-9.",
  ...
  "demigods": "Finiteliving beings empowered with vast intelligence and influence for administration of the material universe on behalf of the Supreme Lord.",
  ...
  "Devahūti": "Thedaughter of Svāyambhuva Manu, wife of the sage Kardama, and mother of the Supreme Lord’s incarnation Kapiladeva. Lord Kapila taught Devahūti the science of pure devotional service through a study of the elements of creation.",
  "Devakī": "The wife of Vasudeva and mother of Kṛṣṇa.",
  "Devaki": "themother of Lord Kṛṣṇa. She was the daughter of King Devaka and a wife ofVasudeva's. When Kṛṣṇa appears in the material world, He first sends some of His devotees to act as His father, mother, etc.",
  ...
  "devas": "Thedemigods who reside in Svarga, led by Indra. They rule the universe andadminister the necessities of life for its inhabitants.",
  ...
  "Dhanañjaya": "aname for Arjuna meaning “he who attains great wealth by conquest.” Thisname refers to Arjuna's collecting vast wealth for Yudhiṣṭhira~s Rājasūya sacrifice.",
  "dhania": "see: coriander",
  "Dhanur Veda": "a Vedic treatise on the science of warfare.",
  "Dhanvantarī": "Theincarnation of Viṣṇu who appeared from the churning of the Ocean of Milk and then delivered to the demigods the nectar of immortality. He isthe first teacher of the Ayur-veda, the Vedic medical science.",
  ...
  "Dhenuka": "(-asura)A demon sent by Kaṁsa to kill Kṛṣṇa and Balarāma. He and other demons took the forms of donkeys and seized control of the Tāalavana (forest ofpalm trees) in Vraja. Balarāma killed him.",
  "Dhenukāsura": "a mystic demon who took the form of a donkey and was killed by Kṛṣṇa.",
  "dhīra": "Steady, sober.",
  "dhobi": "a man who washes clothes.",
  "dhoti": "Asingle long piece of cloth, usually of cotton or silk, that is the standard garment worn on the lower part of the body by men of Vedic culture.",
  "Dhṛṣṭadyumna": "Theson of Drupada. Both he and his twin sister, Draupadī, were born to help destroy the Kuru dynasty. In the Battle of Kurukṣetra he killed Droṇa, the military teacher of the Kuru princes.",
  ...
  "Dhruva Mahārāja": "agreat devotee who at the age of five performed severe austerities and realized the Supreme Personality of Godhead. He received an entire planet, the Pole Star.",
  "Dhruva": "Theyounger son of Uttānapāda, and grandson of Svāyambhuva Manu, and great-grandson of Brahmā. Insulted by his stepmother, Dhruva left home at the age of five and achieved perfection in six months. Lord Vāsudeva gave Dhruva his own spiritual planet at the top of the universe, called Dhruvaloka or the polestar.",
  ...
  "dosas": "avery large, thin pancake. made of fermented rice flour. They are often wrapped round a spiced potato filling and are then called masala dosa.",
  "Draupadī": "Thedaughter of Drupada and wife of all five Pāṇḍavas. Both she and her twin brother, Dhṛṣṭadyumna, were born to help destroy the Kuru dynasty. An attempt to disrobe her in a royal assembly doomed the Kurus to annihilation.",
  "Dravida": "South India.",
  ...
  "Droṇa Vasu": "Aresident of heaven, one of the eight Vasus, who is an empowered expansion of Kṛṣṇa’s eternal father Nanda. Droṇa descended to the earth and merged into Nanda’s body to join Kṛṣṇa’s pastimes.",
  ...
  "Duḥśāsana": "Thesecond of Dhṛtarāṣṭra’s one hundred sons. Duhśāsana, Śakuni, and Karṇa were the inner circle of advisers to Duryodhana and incited him to commit grievous wrongs against the Pāṇḍavas. Bhīma killed Duhśāsana in the Kurukṣetra battle.",
  ...
  "Durgā": "LordŚiva’s eternal consort, of many names and forms, who joins him in his incarnations. She is the creator and controller of the material world.",
  ...
  "Durvāsā Muni": "a partial incarnation of Lord Śiva, a powerful mystic yogī,famous for his fearful curses. He is known for being easily angered. Hegranted a benediction to Kuntī that she could call any demigod and conceive children. Duryodhana once pleased Durvāsā and asked for a benediction that he and his thousands of disciples would visit Yudhiṣṭhira at a time when Draupadī had already eaten from her copper pot. The idea was that Durvāsā would become angry and curse the Pāṇḍavas. The plan back fired because Lord Kṛṣṇa saved the situation. (Vana Parva in Mahābhārata)",
  "Durvāsā": "Apowerful sage, a partial incarnation of Lord Śiva, born as one of the three sons of Atri and Anasuya. He is famous for his angry temperament and his readiness to curse anyone who dissatisfies him.",
  ...
  "Duryodhana": "Theeldest son of Dhṛtarāṣṭra and chief rival of the Pāṇḍavas. He made manyattempts to cheat the Pāṇḍavas of their right to the Kuru throne. Afterarrogantly ignoring the good advice of Bhishma, Drona, and Kṛṣṇa he perished with his ninety-nine brothers in the Kurukñetra battle.",
  ...
  "Dvaipāyana": "See: Vyāsadeva",
  "Dvaitādvaita-vāda": "the Vedānta philosophytaught by Nimbarkācārya. This philosophy posits a simultaneous oneness and difference between the tiny spirit souls and the Supreme Lord. Later, Lord Caitanya gave further development to this idea as acintya-bhedābheda-vāda.",
  ...
  "Dvārakā": "(-purī,Dvāravati) The eternal abode in which Kṛṣṇa fully displays the opulenceof God. While descended on earth, Kṛṣṇa resettled the entire populationof Mathurā in the city of Dvārakā, which He manifested by constructing it on the coast of the western Ānarta province.",
  ...
  "Dvivida": "Apowerful gorilla, once an associate of Jāmbavān in the service of Lord Rāmacandra. Dvivida offended Lord Rāma’s brother Lakṣmaṇa, and because of this and the bad effect of his own brother’s association, Dvivida turned demonic. Thus in a later age he disturbed Lord Balarāma and the Lord’s consorts. Balarāma then killed him.",
  ...
  "Ekādaśī": "Aday on which Vaiṣṇavas fast from grains and beans and increase their remembrance of Kṛṣṇa. It falls on the eleventh day of both the waxing and waning moons.",
  "Ekalavya": "theson of Hiraṇyadhanus, the King of the Niṣadhas. He approached Droṇa to learn the science of archery, but was refused because of his low birth. He later built a deity of Droṇa and thus learned the science of archery.However, Droṇa did not approve of this process and asked for his thumb as dākṣiṇā. Ekalavya submitted and cut off his thumb. He then found he did not have the same skill as before. Ekalavya was latter killed by Lord Śrī Kṛṣṇa.",
  "Emerson, Ralph Waldo (1803-1882)": "anAmerican poet, lecturer and essayist who was the leading member of the Transcendentalists, a group of New England idealists. His view was an eclectic one, and he was much influenced by his studies of Vedic thought.",
  ...
  "fenugreek": "an erect annual herb of the bean family indigenous to western Asia and southeastem Europe. Fenugreek (Trigonella foenum - graecum)is cultivated for its seeds, which, although legumes, are used as a spice. The seeds are small hard, yellowish-brown smooth, and oblong, with a little groove across one corner. Fenugreek has a warm, slightly bitter taste reminiscent of burnt sugar and maple. The seeds are used inGreece and Egypt and especially India, where they are lightly dry-roasted or fried to extract their characteristic flavour. One shouldnote however that over-roasting or frying results in excessive bitter flavours. The leaves of the fenugreek plant are also popular in Indian cuisine. Known as methi, they are used in vegetable dishes, breads, and savouries. Easily home-grown, fresh young fenugreek leaves are wonderful in salads dressed with oil and lemon. Fenugreek seeds are available at Indian or Middle Eastern grocers. The fresh leaves (if you are shopping outside India) can occasionally be found in markets, or canbe home-grown.",
  ...
  "filo pastry": "avery light and paper-thin pastry popular throughout the Middle East andin Greece. This delicate pastry is used for either sweet or savoury dishes. Filo pastry is featured in this book in Spinach and Filo Trianales (Spanakopital), and in Turkish Nut Pastries in Syrup (baklava)Filo is difficult to prepare at home and is best purchased refrigeratedfrom well-stocked supermarkets, delicatessens, and health food stores.",
  ...
  "Gadādhara": "aname for the Personality of Godhead meaning “He who wields a club [in one of His four hands];” an intimate associate of Lord Śrī Caitanya Mahāprabhu.",
  ...
  "Gajendra": "Theking of elephants, a human king in his previous life but cursed to be born an animal. Attacked by a crocodile and unable to free himself, Gajendra remembered Lord Viṣṇu and prayed to Him in full surrender. LordViṣṇu then appeared and saved him.",
  ...
  "Gāndhārī": "thesaintly and faithful wife of King Dhṛtarāṣṭra and mother of one hundredsons. The daughter of King Subala of Gāndhāra. She was a great devotee of Lord Śiva from her childhood. Lord Śiva blessed her with a benediction she could have one hundred sons. Śrīla Vyāsadeva also blessed her with the same benediction. She was married to Dhṛtarāṣṭra, who was blind. When she found out that her future husband was blind, shevoluntarily blindfolded herself for the rest of her life. She is considered one of the most chaste women of all time.",
  ...
  "Gaṅgā": "(-devī)The great sacred river flowing from the peaks of the Himalayas to the Bay of Bengal and delivering from sin everyone who comes in contact withher. When she cascaded down from heaven by the endeavors of King Aṁśumān and his son and grandson, Lord Śiva detained her waters on his head to cushion the earth from the force of her descent.",
  "gāñjā": "marijuana.",
  "Garam masala": "(literally, “hot spices”) A blend of dry-roasted and ground spices well-used in Indian cuisine. The spices used for garam masala warm the body (garammeans warm). Such spices include dried chilies, black pepper, cardamom,coriander, cinnamon, cloves, and cumin. Other spices, such as ajowan, mace, nutmeg, fennel, bay leaves, ginger, and white and green pepper, aswell as other ingredients, such as sesame seeds, coconut, and saffron, are also used according to the region, since Indian cooking styles vary immensely according to the geographical location. Generally, garam masala is added towards the end of cooking. It is available at Indian grocery stores.",
  ...
  "Garbhodakaśāyī Viṣṇu": "thesecond Viṣṇu expansion, who enters each universe and from whose navel grows a lotus upon which Lord Brahmā appears. Brahmā then creates the diverse material manifestations.",
  ...
  "Garuḍa": "Theeternal companion of the Supreme Lord who serves as His personal carrier in the form of a large bird. He appeared as the son of Kaśyapa and Vinatā.",
  ...
  "Gauḍīya Maṭha": "aVaisnava institution, originally with 64 temples in India and elsewhere, founded by Śrīla Bhaktisiddhānta Sarasvatī Thākura for propagating the sacred teachings of Lord Caitanya throughout India and the world. It was first established in 1918 as the Śrī Bhaktivinoda Āsana. In 1919 he re-established it as the Viśva-vaiṣṇava-rāja-sabhā, aninstitution originally established by Śrīla Jīva Gosvāmī and re-instituted by Śrīla Bhaktivinoda Ṭhākura. The organization ultimatelycame to be known as the Gauḍīya Maṭha. Its influenced waned after the passing of Bhaktisiddhānta Sarasvatī Ṭhākura.",
  "Gauḍīya Vaiṣṇava sampradāya": "Theschool of pure devotion to Rādhā and Kṛṣṇa founded by Lord Caitanya Mahāprabhu and His followers. It formally descends from the Brahma-Mādhva sampradāyathrough Lord Caitanya’s initiation by Śrī ĪśvaraPurī.",
  "Gaudiya Vaisnava Sampradaya": "theBengal Vaisanava sect founded by Caitanya Maha-prabhu in the late fifteenth century. Lord Caitanya’s immediate disciples, the six Gosvamis, inititated the resurection of Vrndavana.",
  ...
  "Ghaṭotkaca": "theson of Bhīma by Hidimbī, a Rākṣasa woman. He played a very important role in the Kurukṣetra war. He was killed by Karṇa with the Śakti weaponof Indra.",
  "ghee": "clarified butter; Its delicate flavor and special qualities make it the best of all cooking mediums. Itis used in cooking, in the performance of sacrifices, and for other activities of worship. The oil produced by clarifying butter over gentleheat until all the moisture is driven off and the milk-solids are fullyseparated from the clear butterfat. Ghee is an excellent choice for sauteeing and frying and is much favoured in Indian cooking, as wellas some French, Saudi Arabian, and other Middle Eastern cuisines. The best ghee comes from Holland, Scandinavia, and Australia, although home-made ghee is easy to prepare and cheaper than purchasing ready-made ghee. Ghee can be purchased at Indian or Middle Eastern grocery stores, or some well-stocked supermarkets.",
  "ghṛta": "ghee.",
  "ginger": "the thick, white, tuberous underground stems, or rhizomes, of the plant Zingiber officinale,which thrives in the tropical areas of the world. Fresh ginger root hasa spicy-sweet aroma and a hot, clean taste and is used in many cuisinesespecially throughout China, Japan, Thailand, and India. The young “green” ginger is especially appreciated for its fibre-free texture and mild flavour. Mature ginger root is more readily available at produce markets, Asian grocery stores and some supermarkets. Fresh ginger shouldbe peeled before use. It can be minced, sliced, pureed, shredded, or cut into fine julienne strips and used in vegetable dishes, dals and soups, savouries, fried dishes, chutneys, rices, sweets, and drinks.Ginger powder is not a substitute for fresh ginger, having lost its volatile essential oil, and being sometimes stale or adulterated. Gingerpowder is used mostly in European cooking in puddings, creams, beverages, biscuits, breads, and cakes. It is available at most grocery shops or supermarkets.",
  "giri": "hill.",
  "Giridhārī (Govardhana)-silā": "stonesfrom Govardhana Hill in Vṛndāvana. Worship of these stones was inaugurated by Lord Caitanya and Raghunātha dāsa Gosvāmī. On the basis of statements from Śrīmad-Bhāgavatam, Lord Caitanya established the non-difference of Govardhana Hill and Kṛṣṇa. By such worship Raghunātha dāsa Gosvāmī got the direct darśana of the Lord.",
  ...
  "gluten flour": "aflour made from the protein constituent of wheat flour. It creates an extra-spongy texture when added to breads, by virtue of the elastic network it forms in the dough when water is added.",
  "glutinous rice flour": "apure-white, starch-like flour made from a special round-grain, matt-white rice, which is much stickier than ordinary rice when cooked. It is used in Chinese, Japanese, Vietnamese, and Korean cooking for batters (savoury and sweet) and pastries. Glutinous rice flour is available at any Asian grocery store.",
  "godāsa": "servant of the senses.",
  "Godhead": "the ultimate source of all energies.",
  "godown": "warehouse, storage room.",
  "Gokula": "Thefirst home of the infants Kṛṣṇa and Balarāma in Vraja, before Nanda’s cowherds moved to Nanda-grāma. It is located in the Mahāvana forest, on the eastern shore of the Yamunā, seven miles south of Mathurā City. The name Gokula is also sometimes used to distinguish Kṛṣṇa’s abode on earthfrom Goloka in the spiritual world.",
  "Goldsmith, Oliver (1730-1774)": "anAnglo-lrish author who was famed as an essayist, poet, novelist, playwright, biographer and historian. One of his major poems is “The Deserted Village”.",
  "Goloka Vṛndāvana (Kṛṣṇaloka)": "the highest spiritual planet in the kingdom of God, Lord Kṛṣṇa’s personal abode.",
  "Goloka": "Theeternal abode of the Supreme Lord in His original form of Kṛṣṇa. It is located above all the other Vaikuṇṭha planets. It has three parts:Vṛndāvana, Mathurā, and Dvārakā.",
  "goonda (guṇḍa)": "hired thug.",
  "gopa": "a cowherd boy; one of Kṛṣṇa’s eternal cowherd-boy associates.",
  "Gopāla Bhaṭṭa Gosvāmī": "oneof the Six Gosvāmīs of Vṛndāvana, who directly followed Lord Śrī Caitanya Mahāprabhu and systematically presented His teachings, born at the beginning of the 16th century near Śrī Raṅgam in South India. He metLord Caitanya as a child when the Lord stayed with his father, VyenkataBhaṭṭa, during the four-month rainy season. On the order of Lord Caitanya he journeyed to Vṛndāvana to join the other Gosvāmīs. While on pilgrimage he obtained twelve śālagrama-śīlās. Later, a Dāmodara śilā manifested Himself as the beautiful Rādhā-ramaṇa Deity, Who is worshiped to this day with great eclat. Gopāla Bhaṭṭa assisted Sanātana Gosvāmī in his writing.",
  "Gopāla mantra": "Aconfidential hymn, in ten syllables, to Kṛṣṇa in His original form as ayoung cowherd. Although chanted by the main character in Bṛhad-Bhāgavatāmṛta, Śrīla Sanātana Gosvāmī does not divulge the words of the mantra anywhere in Bṛhad-Bhāgavatamṛta or his commentary on the work. Those who want information on it may consult the Krama-dīpikā of Keśava Bhaṭṭa.",
  ...
  "Gopīs": "the cowherd girls of Vraja, who are generally the counterparts of Śrī Kṛṣṇa’s hlādini-sākti,Śrīmatī Rādhārāṇī. They assist Her as maidservants in her conjugal pastimes with the Supreme Personality of Godhead; Gopāla Kṛṣṇa's cowherdgirl friends, who are His most surrendered and confidential devotees.",
  ...
  "Gosvāmī (goswami)": "Onewho controls his mind and senses; title of one in the renounced order of life. May refer specifically to the six Gosvāmīs of Vṛndāvana, directfollowers of Lord Caitanya who systematically presented His teachings.",
  ...
  "Govardhana": "Girirāja,“the king of mountains,” a large hill located fifteen miles west of Mathurā City. For seven days, Kṛṣṇa lifted Govardhana like a huge umbrella to protect the residents of Vraja from a devastating storm caused by the jealous Indra. Sometimes the name Govardhana refers to thevillage in the center of the hill.",
  ...
  "guṇa-avatāras": "Theempowered incarnations of the Supreme Lord who preside over the three modes of nature. Brahmā, the secondary creator, directs the mode of passion. Śiva, the destroyer, directs ignorance. And Viṣṇu, the maintainer, primary creator, and Supreme Lord Himself, directs goodness.",
  ...
  "guru": "Aspiritual master. The gurus who initiate one and instruct one in pure Kṛṣṇa consciousness are to be honored equally with the Supreme Lord.",
  ...
  "Hari-varṣa": "Oneof the nine divisions of Jambūdvīpa, the central part of the earthly planetary system. Lord Nṛsiṁha and Prahlāda reside in Hari-varṣa.",
  "Haribol": "“Chant the holy name.”",
  "haricot beans": "a member of the Phaseolus vulgarisspecies, which includes not only haricot but kidney beans, great northern beans, and pinto beans. These dried white beans, also knows as navy beans, are popular in soups, stews, and casseroles. They are well-used in Italian cooking and are known as fagiolo secco. They are available at grocery stores and supermarkets.",
  ...
  "Hariścandra": "thetwenty-eighth king in the Tretā-yuga. He appeared in the dynasty of thesun as the son of Triśaṅku, and he is celebrated in the Mārkaṇḍeya Purāṇa as the pious king who satisfied Viśvāmitra Muni by sacrificing his kingdom, wife, and son.",
  ...
  "Himalayas": "Thetallest mountains on earth, on India’s northern edge, described as the residence of sages, demigods, and incarnations like Lord Śiva, Nara-Nārāyaṇa, and Vyāsadeva.",
  ...
  "Hiraṇyakaśipu": "Oneof the first great demons in the universe. He and his demonic brother Hiraṇyākṣa were previously doorkeepers of Vaikuṇṭha but were cursed whenthey refused entrance to the four Kumāra sages. Hiraṇyakaśipu’s son Prahlāda was a fully surrendered devotee of Viṣṇu. For persecuting Prahlāda, Hiraṇyakaśipu was killed by Lord Nṛsiṁha.",
  "Hiraṇyākṣa": "Thedemonic older brother of Hiraṇyakaśipu. When Hiraṇyākṣa tried to obstruct Lord Varāha from lifting the earth from the depths of the Garbha Ocean, the Lord killed him.",
  "Hiraṇyavarman": "a king of Daśārṇa. His daughter was married to Śikhaṇḍī.",
  "Hlādinī śakti": "Kṛṣṇa’s pleasure potency.",
  "Holī": "amajor Hindu holiday celebrated on the last day of the bright fortnight of the month of Phalgun (February-March). This festival is said to be one of Kṛṣṇa’s favorates. The most popular activity is ther throwing of colored water and powder by participants on each other.",
  "horseradish root": "the root of the hardy perennial plant Armoracia rusticana.When scraped or bruised, these stout, white, fleshy, cylindrical roots emit their characteristic highly pungent, penetrating odour, plus volatile oils which cause tears to flow. Horseradish roots are generallypeeled and grated and made into sauces to accompany savoury dishes. When choosing horseradish select large roots. The inside core is woody and is not used. Shred or grate the outside of the root, but use straight away and do not cook it, or else the pungent flavour will fade.Dehydrated powdered horseradish can be used as a substitute, but fresh is better. Fresh horseradish root is sometimes available at quality produce markets and greengrocer shops. The powdered horseradish is available at specialty shops and some supermarkets.",
  ...
  "Ilāvṛta-varṣa": "Thecentral division of Jambūdvīpa, which in turn is the central part of the earthly planetary system. In the center of Ilāvṛta-varṣa stands the great mountain Sumeru. Lord Śiva resides in Ilāvṛta-varṣa with his consort Durgā. Ilavṛta-varṣa was also the ancient name of India before it was renamed after King Bharata, the son of Lord Ṛṣabhadeva.",
  ...
  "jaḍa-yoga": "Aprocess of self-realization by which the yogi completely withdraws his senses and consciousness from all material engagements, exhibiting a total disregard for the safety and maintenance of his material body.",
  ...
  "Jaiminī": "the atheistic propounder and philosopher of Karma-mimāṁsā philosophy, and author of the Karma-mīmāṁsā-sūtras, which explain the Vedasin ritualistic terms, and advocate material work as the purpose of life. He theorized that if fruitive activity is performed nicely, then God is obliged to give the results.",
  ...
  "Jāmbavatī": "Thedaughter of Jāmbavān. After Kṛṣṇa fought Jaāmbavān over the Syamantaka jewel, Jāmbavān surrendered to Kṛṣṇa and offered Him Jāmbavatī, who became one of Kṛṣṇa’s eight principal queens.",
  ...
  "jarā": "old age.",
  "Jarāsandha": "Apowerful enemy of Kṛṣṇa’s, the emperor of the Magadha kingdom. Yudhiṣṭhira could not perform the Rājasūya sacrifice without first neutralizing Jarāsandha’s opposition, so Kṛṣṇa arranged for Jarāsandha to be killed by Bhīma.",
  "jari": "Ornate embroidery with silver or gold thread.",
  "jāta-karma": "a purificatory ceremony performed at the birth of a child.",
  "Jaṭāsura": "aRākṣasa who disguised himself as a brāhmaṇa and tried to kidnap Draupadī and four of the Pāṇḍavas except for Bhīma. Bhīma challenged himand killed him in single combat.",
  "Jaṭāyu": "Avulture who tried to stop Rāvaṇa from kidnapping Sītādevī. Mortally wounded by Rāvaṇa, he died in the arms of the grateful Lord Rāmacandra.",
  "Jaya and Vijaya": "Theguards of a main gate of Vaikuṇṭha. When the four Kumāra sages tried toenter Vaikuṇṭha, Jaya and Vijaya stopped them and were cursed to fall down into the material world. Thus they were successively born as the demons Hiraṇyakṣa and Hiraṇyakaśipu, Rāvaṇa and Kumbhakarṇa, and Śiśupāla and Dantavakra.",
  ...
  "Jayadratha": "Theking of Sindhu-deṣa and brother-in-law of Duryodhana. He once kidnappedDraupadī, the wife of the Pāṇḍavas, and so the Pāṇḍavas captured and humiliated him. He was a commander in the Kuru army at Kurukṣetra and was killed by Arjuna.",
  "Jāyanteyas": "nine great sages, sons of King Bharata, who were also known as the nine Yogendras.",
  "Jayatsena": "theson of Jarāsandha. He took the side of Duryodhana in the Kurukṣetra warand was killed by Abhimanyu. (Droṇa Parva in Mahābhārata)",
  "Jhulana yatra": "theswing festival beginning on the third day of the month of Shravan (July-August) and lasting for a fortnight. The swings, usually made fromgold or silver, are hung in temples on which the Deities are swung during kirtan by the guests and Vaisnavas.",
  ...
  "jvalitā": "thestage exhibited by a devotee when more than two or three transcendentaltransformations are manifest and it is possible to conceal them with difficulty.",
  "Jyotiḥ-śāstra": "the Vedic science of astronomy.",
  "Jyotir-linga": "one of the 12 selfmanifested Śiva-lingas",
  "Kabandha": "a son of Śrī. Indra once stuffed his legs and head into his belly as a punishment. Indra foretoldthat until his long arms were cut off by Lord Rāma (which later occurred), Kabandha would not achieve peace.",
  ...
  "kaivalyam": "thestate of realization of one's constitutional position as part and parcel of the Supreme Lord, which is preliminary to manifestation of activities on the platform of devotional service.",
  ...
  "Kālayavana": "Abarbarian king who tried to attack Kṛṣṇa. Not wanting to touch a barbarian, Kṛṣṇa arranged for him to be killed by King Mucukunda, who burned Kālayavana to ashes with his glance.",
  ...
  "Kālī": "see: Durgā",
  "Kali-yuga": "the “Age of Quarrel and Hypocrisy ” The fourth and last age in the cycle of a mahā-yuga. Thisis the present age in which we are now living. It began 5,000 years agoand lasts for a total of 432,000 years. It is characterized by irreligious practice and stringent material miseries. In the Śrīmad-Bhāgavatam theage is personified as an evil black man who tries to kill a helpless cow and bull. The four legs of the cow represent the four principles of religiosity",
  "Kālindī": "The river Yamunā, who became one of Kṛṣṇa’s eight principal queens in Dvārakā.",
  "Kaliṅga": "a province in ancient India.",
  "Kāliya": "Amany-headed serpent who poisoned a lake within the Yamunā. Kṛṣṇa subdued the serpent by dancing on his hoods and then banished him from Vraja.",
  "Kalki": "Heis the tenth incarnation of Lord Viṣṇu. He arrives on a white horse at the end of Kali-yuga to annihilate all the remaining atheists.",
  "kalmaṣa": "sin.",
  "kalonji seeds": "alsoknown as nigella or black onion seed no relation to the  onion. Very often these small, black, tear-drop-shaped seeds are confused with, or called, black cumin seeds, which in fact, they are not. Kalonji seeds (Nigella satival)have a peppery taste and,  when heated, have an herbal aroma. They are an important ingredient in the Bengali spice blend called  panch puran. They are available at Indian grocery stores",
  ...
  "Kaṁsa": "Theking of Bhoja and son of Ugrasena who usurped the throne of Mathurā. After sending many demons to Vraja to kill Kṛṣṇa and Balarāma, he finally brought the brothers to Mathurā for a rigged wrestling tournament, where Kṛṣṇa killed him.",
  ...
  "karma-mīmāṁsā": "oneof the six main Vedic philosophies. It states that the subtle laws of nature reward or punish one according to how one acts, without referenceto an independent God.",
  ...
  "Kartavirya Arjuna": "Ademonic thousand-armed king who tyrannized much of the world but was killed by Lord Paraśurama after murdering Lord Paraśurāma’s father, the sage Jamadagni.",
  "Kārtikka": "The Vedic month corresponding to Octoberâ€ “November in which Lord Dāmodara is worshiped.",
  "Kārttika": "thename of a Vedic month occurring around October-November of the solar calendar, in which the Dāmodara form of Lord Kṛṣṇa is worshiped.",
  ...
  "Kaśyapa": "Oneof the original Prajāpatis, the populators of the universe. Son of Brahmā’s first mind-born son, Marici, he married thirteen of Dakṣa’s daughters and fathered many demigods, demons, and species of animals.",
  ...
  "kaustubha": "A jewel worn by Lord Viṣṇu on His chest. It is one of the few marksvisibly distinguishing Him from His devotees in Vaikuṇṭha.",
  ...
  "Kekaya": "Akingdom in the northwest of Punjab, between the Śatadrū and Vipāśā rivers. Kekaya princes fought on both sides of the Kurukṣetra battle.",
  ...
  "Kesava Gaudiya Matha": "Thistemple was established by Srila Bhaktiprajnana Kesava Gosvami Maharaja,the sannyasa-guru of A.C. Bhaktivedanta Swami Prabhupada. The presidingDeities are Sri Sri Radha-vinoda-vihari.",
  ...
  "kevala": "devotionalplatform of seeing the unlimited potency of Kṛṣṇa but still consideringoneself equal with Him; pure, uncontaminated emotion.",
  ...
  "Khāṇḍava": "Aforest near the Pāṇḍava capital, Indraprastha. Kṛṣṇa and Arjuna fought against Indra to allow the fire-god, Agni, to consume the forest.",
  "Khāṇḍavaprastha": "anothername for Indraprastha. The forest in the part of the Kuru kingdom was devoured by Agni with the help of Lord Kṛṣṇa and Arjuna.",
  ...
  "Khetari": "birthplaceand residence of the great Vaiṣṇava Śrīla Narottama dāsa Ṭhākura and site of a magnificent festival and Deity installation in which thousandsof devotees took part, located in the West Bengal district of Rajasahi.",
  "Kīcaka": "brother-in-lawof King Virāṭa. He was killed during the last year of the Pāṇḍavas exile in the kingdom of Virāṭa. When he lusted after Draupadī, he was killed by Bhīma.",
  ...
  "Kindama": "asage who was killed by Pāṇḍu in the forest. Kindama had taken the form of a deer and was enjoying sex with his wife. Pāṇḍu, thinking the deer fit for sacrifice, killed the deer and its mate. Before leaving his body, Kindama cursed Pāṇḍu to die while he was enjoying his wife.",
  "Kinnaras": "minor demigods inhabiting the heavenly planets. They can change their form at will.",
  "Kirāta": "amountainous region near modern Udaipur, Rajasthan, where Arjuna did penance. Lord Śiva took the form of a Kirāta and fought with Arjuna.",
  "Kirāṭas": "A degraded tribe of mountain-dwelling hunters.",
  "Kirīṭī": "another name for Arjuna.",
  "Kirmīra": "a fierce Rākṣasa and the brother of Baka. He was killed by Bhīmaduring their exile in the forest. (Vana Parva in Mahābhārata)",
  "kīrtana": "The primary devotional practice of chanting the Supreme Lord’s glories.",
  "Kīrtana": "glorificationof the Supreme Lord. Narrating or singing the glories of the Supreme Personality of Godhead and His Holy Names; the devotional process of chanting the names and glories of the Supreme Lord.",
  "Kiṣkindha": "Thecapital city of the Vānara ape-men, ruled during the time of Lord Rāmacandra first by Vāli and later by Vāli’s brother Sugrīva. The Vānaraarmy, led by Sugrīva and ministers like Hanumān, helped Lord Rāma defeat Rāvaṇa.",
  ...
  "Kosala": "Thekingdom of north-central India ruled by great kings like Sagara, Bhagīratha, Khaṭvānga, Raghu, Daśaratha, and Lord Rāmacandra. Its capital was Ayodhya.",
  "koṭī": "ten million.",
  "Kovil": "temple in Tamil Nadu.",
  "Kratu": "one of the seven great sages who were born directly from Lord Brahmā.",
  "Krishnanagar": "atown that is the government headquarters of a sub-division of the West Bengal district of Nadia. It is about ten miles east of Śrī Māyapura.",
  ...
  "Kṛṣṇa": "(-candra)The Supreme Personality of Godhead in His original form, enjoying as a youthful cowherd with His family and friends in Vṛndavana and later as avaliant prince in Mathura and Dvāraka.",
  ...
  "Kṛtavarmā": "aking of the Vṛṣṇi dynasty, and the son of Hādīka. He took the side of Duryodhana during the battle of Kurukṣetra. He was killed during the fratricidal war of the Yadus.",
  "kṣara": "perishable.",
  ...
  "kṣatriya": "third of the four orders of the varṇāśramasystem. A warrior who is inclined to fight and lead others. The administrative or protective occupation according to the system of four social and spiritual orders.",
  ...
  "kṣetrajña": "one who is conscious of the body. Both the soul and the Supersoul are kṣetrajña, forthe individual soul is conscious of his own particular body and the Supersoul is conscious of the bodies of all living beings.",
  "kṣīra": "Sweetened condensed milk.",
  "Kṣīracorā": "Gopīnātha Deity who stole condensed milk for Mādhavendra Purī.",
  "Kṣīrodaka-śāyī Viṣṇu": "Thethird of the three Puruṣas, incarnations of the Supreme Lord for the creation of the material universe. Kṣīrodaka-śāyī Viṣṇu resides on the island of Śvetadvīpa in the Milk Ocean and expands into the heart of every materially embodied being as the Supersoul.",
  "Kṣīrodakaśāyī Viṣṇu": "theViṣṇu expansion of the Supreme Lord who enters within each atom and between each atom of the universe and enters the heart of every living entity. He is also called the Supersoul.",
  ...
  "Kubjā": "Ahunchback woman of Mathurā employed as a seller of fragrant ointments. Attracted to Kṛṣṇa when He entered Mathurā, she happily agreed to supplyHim ointment without payment and applied it to His body. As a reward Kṛṣṇa transformed her into a beautiful young lady. Kṛṣṇa later visited her home along with Uddhava.",
  ...
  "Kumāras": "Thefirst four sons of Brahma. Brahma requested them to beget children, butthey refused, preferring to remain forever celibate in the bodies of five-year-olds.",
  "kumbha": "pitcher.",
  ...
  "Kumbhakarṇa": "Oneof Rāvaṇa’s brothers, a mighty demon, his appetite insatiable, who slept six months of the year. When Rāvaṇa needed help to meet the attackof Lord Rāmacandra’s army, Kumbhakarṇa was with great difficulty awakened, but he was sent to his death by Lord Rāma’s arrows.",
  ...
  "Kuṇḍadhāra": "oneof the one hundred sons of Dhṛtarāṣṭra. He was killed by Bhīma during the battle of Kurukṣetra. (Bhīṣma Parva in Mahābhārata)",
  "Kuṇḍaja": "oneof the one hundred sons of Dhṛtarāṣṭra. He was killed by Bhīma during the battle of Kurukṣetra. (Bhīṣma Parva in Mahābhārata)",
  "Kuṇḍalī": "oneof the one hundred sons of Dhṛtarāṣṭra. He was killed by Bhīma during the battle of Kurukṣetra. (Bhīṣma Parva in Mahābhārata)",
  "Kuṇḍina": "(-pura) The capital of the kingdom of Vidarbha, ruled in the time of Kṛṣṇa by Bhīṣmaka, the father of Śrī Rukmiṇī.",
  "Kuṇḍodara": "oneof the one hundred sons of Dhṛtarāṣṭra. He was killed by Bhīma during the battle of Kurukṣetra. (Bhīṣma Parva in Mahābhārata)",
  "kuñja": "A grove.",
  ...
  "Kurukṣetra": "“The holy field of the Kurus,” where in ancient times the members ofthat dynasty performed sacrifices. Lord Kṛṣṇa spoke the Bhagavad-gītāto Arjuna just prior to beginning the battle fought there that decided the fate of the dynasty and ushered in the beginning of the Kali-yuga.",
  "Kurus": "allof the descendants of King Kuru, but specifically the 100 sons of Dhṛtarāṣṭra. The Pāṇḍavas were also descendants of King Kuru, but Dhṛtarāṣṭra wished to exclude them from the family tradition; enemies ofthe Pāṇḍavas.",
  ...
  "Kuvalayāpīḍa": "Anelephant deployed by King Kaṁsa to kill Kṛṣṇa and Balarāma when They came to Mathurā. Kṛṣṇa killed the elephant and later used one of its tusks to kill Kaṁsa’s soldiers.",
  ...
  "Laksman Sen": "Kingof Bengal in the 12th century. His grandfather, Vijaya Sen, founded thecity of Navadvīpa in 1063 on the eastern bank of the Ganges. Laksman Sen was crowned king in 1178, and he made Navadvīpa his capital. The ruins of his kingdom can still be found in the villages of Bamanpukur and Māyāpura. He was a great patron of learning and sponsored the famousJayadeva Gosvāmī, author of Gītā-govinda.",
  "Lakṣmaṇa": "Theeldest of Lord Rāmacandra’s three younger brothers. He faithfully followed Rāma and Sītā into forest exile and stood by Rāma’s side throughout the struggle to defeat Rāvaṇa.",
  ...
  "Lalitā": "Oneof Śrīmatī Rādhārāṇī’s intimate friends, who are Her principal expansions, the original potencies behind all spiritual and material creations. Being a little older than Rādhārāṇī, Lalitā often advises Heron proper behavior.",
  "Laṅkā": "Thedemon Rāvaṇa’s island kingdom (or, also, his capital), often identifiedwith the modern country Sri Lanka. Rāvaṇa’s kingdom was demolished by Lord Rāmacandra’s army.",
  "laos": "see: Galangal",
  ...
  "Līlā-avatāras": "innumerableincarnations, like Matsya, Kurma, Rāma and Nṛsiṁha, who descend to display the spiritual pastimes of the Personality of Godhead in the material world.",
  "Līlā-śakti": "Kṛṣṇa’s internal potency, the energy that helps to enact His pastimes.",
  "līlā-smaraṇa": "“Remembrance of the Supreme Lord’s pastimes,” an elevated internal formof devotional service that can be rightly practiced only by those whosehearts are thoroughly pure.",
  "lima beans": "popular in European cuisine, lima beans (Phaseolus lunatas),are also known as butter beans, and are available large or small. They are tasty additions to soups, stews, and salads and are featured in thisbook in Lima Bean and Cheese Croquettes. They are available at supermarkets and grocery stores.",
  "lime leaves": "thefresh or dried leaves of the lime tree. They are used in South East Asian and especially, Indonesian cooking. The leaves are used in rice, stews, and vegetable dishes to impart a pleasant lime taste.",
  ...
  "loka": "planet.",
  "loka-pāla": "ageneric term for the deity presiding over one of the directions: Indra for the east, Agni for the southeast. Yama for the south, Sūrya for the southwest, Varuṇa for the west, Vāyu for the northwest, Kuvera for the north, and Candra for the northeast.",
  ...
  "Lomaśa": "asage who guided the Pāṇḍavas during their exile in the forest. He took them to many places of pilgrimage. (Vana Parva in Mahābhārata)",
  "lorry": "truck",
  "lotus feet": "Withthe lotus regarded as an emblem of beauty in the material world, the term “lotus” is accepted to describe the all-pure and all-attractive feet of the Supreme Lord or His pure devotee.",
  ...
  "mādhukarī": "asaintly mendicant who takes a little food from each householder’s placelike a bee gathering honey; a system of begging adopted by a mendicant.",
  "Madhumaṅgala": "A young brāhmaṇaboy who was among Kṛṣṇa’s closest playmates. He was the son of Sāndīpani Muni (Kṛṣṇa and Balarāma’s teacher in Avanti) and the grandsonof Paurṇamāsī. When Paurṇamāsī moved to Vraja, Madhumaṇgala came with her.",
  ...
  "Madhvācārya": "The founding ācārya of one of the four Vaiṣṇava sampradāyas in Kali-yuga. He appeared in the thirteenth century as a Karnataka brāhmaṇa,taught a strictly theistic version of Vedānta philosophy, vigorously opposed the Advaita-vāda of Śaṅkarācārya, and established the worship ofŚrī Kṛṣṇa at Udupi.",
  "madhya-līlā": "Thepastimes Lord Caitanya performed during the middle part of His manifestpresence, while He was traveling throughout India; the portion of Śrī Caitanya-caritāmṛta recounting those pastimes.",
  "Madhya-līlā": "thepastimes Lord Caitanya performed during the middle part of His manifestpresence, while He was traveling throughout India; the portion of the Caitanya-caritāmṛta recounting those pastimes.",
  ...
  "mahā-bhāva": "Theultimate limit of devotional ecstasy, found only in Śrī Rādhā and some of Her intimate servants. Śrī Caitanya Mahāprabhu, who was Śrī Kṛṣṇa in the mood of Śrī Rādhā, also displayed such ecstasy.",
  ...
  "Mahā-dvādaśī": "theday after Ekādaśī, celebrated instead of Ekādaśi because of astronomical overlapping. Lord Kṛṣṇa calls it Ekādaśī if a fast is observed on that day.",
  ...
  "Mahā-mantra": "thegreat chanting for deliverance: Hare Kṛṣṇa, Hare Kṛṣṇa, Kṛṣṇa Kṛṣṇa, Hare Hare Hare Rāma, Hare Rāma, Rāma Rāma, Hare Hare; is the great mantra composed of the principal names of Godhead in their vocative forms. This maha-mantra is found in the Purāṇas and Upaniṣads andis specifically recommended for chanting in this age of Kali as the only means of God realization. Lord Caitanya personally designated it asthe mahā-mantra and practically demonstrated the effects of the chanting.",
  "Mahā-māya": "See Māya.",
  "Mahā-māyā": "thematerial nature; the external potency of the Supreme Lord, which bewilders the conditioned living entities. She is personified as Durgā-devī; the illusory, material energy of the Supreme Lord.",
  "mahā-paṇḍita": "a very learned person.",
  "mahā-prasāda": "Fooddirectly from the plate that has been offered to the Supreme Lord. Suchfood from Lord Jagannātha at Purī is especially known as mahā-prasāda, but Śrīla Sanātana Gosvāmī uses the term to refer to Kṛṣṇa’s prasāda in general.",
  ...
  "Mahā-Viṣṇu": "Thefirst of the three Puruṣas, incarnations of the Supreme Lord for the creation of the material universe. He lies down in the Causal Ocean on the bed of Ananta Śeṣa and initiates the creation by glancing at His personified material energy, Māya.",
  ...
  "Mahājana": "oneof the twelve great self-realized souls, authorized agents of the Lord whose duty is to preach the cult of devotional service to the people in general; one who understands the Absolute Truth and throughout his life behaves likes a pure devotee.",
  ...
  "Mahapuri": "oneof the pilgrimage citties in India where residence brings salvation. The seven maha-puris are Mathura, Ayodhya, Hardwar, Varanasi, Kanchi, Ujjain, and Dwarka.",
  ...
  "Maināka": "thismountain was the son of Himavan during the Satya-yuga, when mountains had wings. Its wings were clipped, and it was placed in the ocean by Indra.",
  "Maitreya Muni": "the great sage who spoke Śrīmād-Bhagāvātām toVidura, who gave advice to the Pāṇḍavas during their exile in the forest. He cursed Duryodhana that Bhīma would fulfill his vow.",
  "Maitreya": "Asage who was a friend of Dvaipāyana Vyāsa. Maitreya heard Kṛṣṇa’s discussions with Uddhava just before Kṛṣṇa’s disappearance and passed onwhat he learned to Vidura. The conversations of Maitreya and Vidura make up the Third and Fourth Cantos of Śrīmad-Bhāgavatam.",
  ...
  "Mānasa-sarovara": "Asacred lake on Kailāsa Mountain. Indra tried to hide within the lake from his sins, and Ambarīṣa meditated by its shore. The lotuses growing in this lake are prized even by the residents of heaven.",
  "Mānasarovara": "a lake north of India, near Mount Kailāsa.",
  "Mānasī-gaṅga": "Themost sacred of lakes, located at the midpoint of Govardhana Hill. Kṛṣṇacreated it from His mind and filled it with the waters of the Gaṅgā andall other holy rivers and lakes to dissuade His father from leaving Vraja to go on pilgrimage.",
  ...
  "maṅgalācaraṇa": "Versesan author composes as an invocation with which to begin a book. The three aims of such an invocation are to offer respects to one’s worshipable Deity, to offer blessings to the readers, and to set forth the topic of the book.",
  ...
  "Manvantara-avatāras": "theincarnations of the Supreme Lord who appear during the reign of each Manu (306,720,000 years); used as a standard division of history.",
  "marakaṭa": "Emerald.",
  ...
  "marjoram": "oneof the most important of all kitchen herbs, it is used in virtually every type of European cuisine, although not very much used in Eastern cooking. Marjoram (Majorana hortensis) has a delicate, pleasant, sweet flavour with a slightly bitter, aromatic undertone. It is generally used in its dried form, for soup, stews, vegetable dishes, andsauces. As a fresh herb, it is delicious in salads. Dried marjoram is available at any supermarket or grocer. Fresh marjoram is occasionally available at produce markets and at good greengrocers.",
  "Mārkaṇḍeya Purāṇa": "the Purāṇa of Mārkaṇḍeya Ṛṣi.",
  "Mārkaṇḍeya Ṛṣi": "anancient sage who narrated the Mārkaṇḍeya Purāṇa, which, describes the nature of Krṣṇa. He beheld the Lord lying down on a Banyan leaf during the period of universal devastation",
  ...
  "māyā": "TheSupreme Lord’s inferior, material energy. She creates and controls the material world, keeping its inhabitants in countless varieties of illusion.",
  "Maya": "Thechief architect of the demons. When Kṛṣṇa and Arjuna saved him from thefire in the Khāṇḍava forest, he became their friend and built a wonderful assembly hall for the Pāṇḍavas at Indraprastha.",
  "māyā-śakti": "see: māyā.",
  ...
  "Māyāvāda": "Theimpersonal philosophy of “oneness,” which holds that the Absolute Truth, one without a second, is formless and changeless, and that whatever has name and form is an illusion falsely imposed on that Truth.The most influential proponent of Māyāvāda in the current age was Śankarācārya.",
  "māyāvāda": "the impersonal philosophy first propounded by Śaṅkarācārya, which proposes the unqualified onenessof God and the living entities (who are both conceived of as being ultimately formless) and the nonreality of manifest nature; the philosophy that everything is one and that the Absolute Truth is not a person.",
  ...
  "Meru": "Thegreat mountain that is the axis of the universe. It is also called Sumeru and Mahāmeru. It extends upward through the center of the earthlyplanetary system, and on its upper peak lies Satyaloka, the abode of Lord Brahmā.",
  "mezze": "Middle Eastern hors d'oeuvres or appetizers. Mezze is essentially a Lebanese creation but has spread throughout the Middle East. Delicious vegetarian mezze included in this book are fresh, round Middle Eastern Breads (Pita) and dips such asChickpea and Sesame Dip (Hummus), Lebanese Eggplant Dip (Babagannonj, and Syrian Yogurt Cheese Labreh). Lebanese Bulgur Wheat Salad (Tabbouleh) invariably appears on the mezze banquet table, as do varieties of Stuffed Vine Leaves (Dolmades),along with simple items such as slices of cucumber, olives, fresh raw or blanched vegetables, nuts, whole cooked chickpeas, and lemon wedges.",
  ...
  "mleccha": "Aclass of persons outside the social and spiritual divisions of Vedic culture, whose standards and practices are considered abominable.",
  ...
  "Mucukunda": "Ason of King Māndhātā whose valiant fighting for the demigods won him a boon by which his glance burned to ashes the barbarian Kālayavana, who had been chasing Kṛṣṇa.",
  "Mūḍha": "Fool, rascal.",
  ...
  "mung beans sprouts": "sprouted,whole green mung beans. Popular in Chinese cooking, the mung beans are allowed to sprout until quite long. However, from a nutritional point ofview, mung beans are best used when the beans have just sprouted and the shoot is less than 1 cm long. These are crisp in texture and bursting with nutrition. Mung bean shoots are rich in vitamins B, C, andE. Their protein content (mung bean shoots are 37% protein) is highly digestible; they are pleasantly sweet, low calorie, and inexpensive.",
  ...
  "mung dal": "the pale, yellow beans from the plant Phaseolus aureus. Whether used with or without the husks, split mung beans are a popular food item in Indian cuisine. Mung dalis easy to digest, is high in protein, and cooks to a creamy puree in ashort time. It is used extensively in soups, stews, and sauces throughout India. Split mung beans are also used in Thai and Vietnamese cooking. It is available at Indian or Asian grocery stores.",
  "muni": "A thoughtful sage.",
  "muni-putra": "the son of a sage.",
  "Mura": "Afive-headed demon employed by Narakāsura to guard the fortress of his capital, Prāgjyotiṣa-pura. When Kṛṣṇa invaded, He killed Mura and then Naraka.",
  ...
  "Nāhuṣa": "Aking of the earth who was invited to occupy Indra’s throne when Indra, out of fear of a demon, fled from his post. Nāhuṣa abused his privileges, however, and was cursed by the seven sages to fall from his position.",
  ...
  "naimittika-karma": "“Occasional ritual duties” enjoined for specific circumstances, such asa death in one’s family during the performance of a sacrifice.",
  ...
  "Nalakūvara and Maṇigrīva": "Thesons of the treasurer of the demigods, Kuvera, who were cursed for their decadence by the great devotee-sage Nārada and who, by his blessing, were delivered from their materialism by Lord Kṛṣṇa.",
  ...
  "nāmābhāsa": "the stage just above theoffensive stage of chanting the name of God, in which one realizes adim reflection of the holy name.",
  ...
  "Nanda": "(-gopa)The king of the cowherds of Vraja. He and his wife Yaśodā, the greatestof devotees in the mood of parents, raised Kṛṣṇa from His infancy untilHe left Vraja for Mathurā.",
  ...
  "Nanda-vraja": "“The cow pastures of Nanda,” the sacred district of Mathurā that is themanifestation on earth of Goloka Vṛndāvana, the supreme abode of Kṛṣṇa.",
  "Nandana": "(-vana) The pleasure gardens of the demigods in Svargaloka.",
  "Nandana-kānana": "thebeautiful forest in the celestial world where Lord Indra sports with his wife and where there is heavenly music and dancing.",
  ...
  "Nara-Nārāyaṇa": "Theincarnation of the Supreme Lord as the twin sons of Dharma and Mūrti. Nara is an empowered jīva, and Nārāyaṇa is directly the Personality of Godhead. They live at Badarika, practicing severe austerities and meditation for the welfare and instruction of the world. Nārada Muni is among their disciples.",
  "Nārada Muni": "Agreat devotee of Lord Kṛṣṇa who travels throughout the spiritual and material worlds singing the Lord’s glories and preaching the path of devotional service.",
  ...
  "Narasiṁha, Lord": "see: Nṛsiṁhadeva",
  ...
  "Navadvīpa": "LordCaitanya Mahāprabhu’s eternal abode, nondifferent from Kṛṣṇa’s abode Vṛndāvana. On earth Navadvīpa is manifest in the district of Nadia, WestBengal.",
  ...
  "Newman, John Henry (1801-1890)": "anEnglish cardinal who became one of the most outstanding European religious thinkers and essayists of the 19th century. He spent his life defending Christian truth against various forms of so-called rationalism.",
  ...
  "nirvāṇa": "Cessation of all material activities. Buddhists and other impersonalists regard nirvāṇaas requiring obliteration of individual existence, but Vaiṣṇavas regardceasing from material activities to be only the beginning of real spiritual life, in which an individual acts in pure devotional service.",
  ...
  "nitya-mukta": "“Eternally liberated,” a person who has never fallen into material illusion and never deviated from the Supreme Lord’s loving service. Nitya-muktasgenerally live in the spiritual kingdom of God, but they sometimes descend to the material world to preach and for other special missions.",
  ...
  "nivṛtti-mārga": "thepath of renunciation, which leads to liberation; directions for giving up the material world for higher spiritual understanding.",
  ...
  "Nṛsiṁha (-deva)": "Thepastime incarnation of the Supreme Lord Viṣṇu as half-man, half-lion. He appeared in order to deliver the saintly child Prahlāda from the persecutions of his father, Hiraṇyakaśipu. When Hiraṇyakaśipu demanded of Prahlāda, “If your God is everywhere, is He also in this pillar?” Lord Nṛsiṁha burst out of the pillar and ripped Hiraṇyakaśipu apart.",
  ...
  "om tat sat": "the three transcendental syllables used by brāhmaṇas forsatisfaction of the Supreme when chanting Vedic hymns or offering sacrifice. They indicate the Supreme Absolute Truth, the Personality of Godhead.",
  ...
  "orange blossom water": "thefragrant water distilled from orange blossoms and used particularly in Middle Eastern cuisine. France produces and exports high-quality orange-blossom water, as does the Levant, particularly Beirut. It can beused in savoury rices, sweets, and drinks.",
  "oregano": "apiquant herb famous in Greek and Italian cuisine. Oregano is botanically confused with marjoram. In fact for many years both marjoramand oregano were known as Marjorana hortensis. There is still confusion today",
  "pāṇi": "water.",
  ...
  "Padmanābha": "aname of the Supreme Personality of Godhead meaning “He who has a lotus flower sprouting from His navel” or “He whose navel resembles a lotus.”",
  ...
  "PAMHO. AGTSP.": "Anacronym, often used in written correspondence as a standard greeting among devotees: “Please accept my humble obeisances. All glories to Śrīla Prabhupāda.”",
  ...
  "Pañca-tattva": "theLord-Śrī Caitanya Mahāprabhu, His plenary portion-Nityānanda Prabhu, His incarnation-Advaita Prabhu, His energy-Gadādhara Prabhu, and His devotee-Śrīvāsa Ṭhākura.",
  "Pañcajana": "Apowerful demon who lived in a conch in the ocean. He kidnapped the son of Kṛṣṇa’s teacher, Sāndīpani. Kṛṣṇa killed Pañcajana and rescued the boy.",
  ...
  "pañcopāsanā": "worshipby impersonalist Māyāvādīs of five deities (Viṣṇu, Durgā, Brahmā, Gaṇeśa and Vivasvān) that is motivated by the desire to ultimately abandon all conceptions of a personal Absolute.",
  ...
  "Pāṇḍavas": "Thefive sons of Pāṇḍu. The three older Pāṇḍavas Yudhiṣṭhira, Bhīma, and Arjuna were born to Pāṇḍu’s wife Kuntī by the three demigods Yamarāja, Vāyu, and Indra. The other two sons, Nakula and Sahadeva, were born of Pāṇḍu’s other wife Mādrī by the Aśvini-kumāras.",
  "paṇḍita": "A scholar.",
  "Paṇḍita": "ascholar learned in Vedic literature, not only academically but also by dint of spiritual realization. Though this is the proper definition of the word, the term is also loosely applied to any scholar.",
  ...
  "Pāṇḍu": "TheKuru emperor after Vicitravīrya. When Vicitravīrya died childless, Pāṇḍu was born from one of Vicitravīrya’s wives, Ambalikā, by DvaipāyanaVyasa.",
  ...
  "Pāpahāriṇī": "aname for the Ekādaśī that occurs during the dark part of the month of Caitra. It means “that which takes away sin.” Another name for this day,having the same meaning, is Pāpamocani.",
  "Pāpānkuṣā": "thename for the Ekādaśī that occurs during the light part of the month of Aśvina. It means “that which has the power to pierce sin personified.”",
  "pappadam": "plain or spiced wafer-thin brittle disks made from dried dalpaste that swell into thin tasty crispbreads when deep-fried or toastedover an open flame. Ranging from 7-25 cm (3-10 inches) in width, pappadamsare popular served as accompaniments to a full meal, as snacks, or as party nibblers. They're available at Indian grocery stores.",
  ...
  "parakīya": "therelationship between a married woman and her paramour; particularly therelationship between the damsels of Vṛndāvana and Krṣṇa.",
  ...
  "paramahaṁsa bābājī": "hewho is on the highest platform of spiritual asceticism and who has given up all social and caste designations. The only designation maintained by him is that of being a tiny servant of the unlimited Supreme Personality of Godhead.",
  ...
  "parijāta": "Anexquisite flower that grows only in the spiritual world and on the heavenly planets. Defeating the opposition of Indra, Kṛṣṇa brought a parijāta tree from Svargaloka for His wife Satyabhāmā and planted it in her garden in Dvāraka.",
  ...
  "Parīkṣit": "Theson of Abhimanyu who inherited the Kuru throne from Yudhiṣṭhira. Kṛṣṇa personally saved him in his mother’s womb, and thus the child was named Parīkṣit because he was searching (parikṣeta) for the person who had protected him.",
  ...
  "parmesan": "the most famous of all the grana, or matured hard cheeses of Italy, parmesan, or parmigiano,takes at least two years to come to maturity, resulting in its traditional sharp flavour. Parmesan cheese should be bought in pieces tobe freshly grated over sauces, pasta, or rice, or added to cooked dishes.",
  "parṣadas": "Personal associates of the Supreme Lord.",
  "parsley": "oneof the best known and most extensively used culinary herbs in western cuisine. There are numerous cultivated varieties of parsley, but the ornamental curled variety is the most popular as a garnish, and the flat-leaved parsley is most favoured in Italian and other Mediterranean cuisines. Both are varieties of Petroselinum crispum Healthful parsley leaves, with their familiar mild, agreeable flavour, are an excellent source of vitamin C, iron, iodine, and other minerals. Parsleyis appealing to the eye nose, and taste, will sweeten the breath, and is a natural herbal deodorizer. It is a pleasant addition to an enormousvariety of savoury dishes. It is available at produce markets, greengrocers, and supermarkets.",
  ...
  "Pātālaloka": "thelowest of the universe’s fourteen planetary systems; also, the lower planets in general; also the seventh tier of the lower planetary systems, where Bali Mahārāja reigns.",
  ...
  "pinenut": "also known as pine kernel, pignolia, or pinoli. Pinenuts come from the stone pine (Pinus pinea),a beautiful Mediterranean pine tree. The pine cones are gathered, the seeds are shaken out and cracked, and the small white or cream-coloured kernels are extracted. Their delicious, delicate nutty taste has made them a very popular ingredient in Italian, Spanish, and Middle Eastern cuisine. They are available at specialty, Continental, or Middle Easterngrocers.",
  ...
  "Plakṣa-dvīpa": "Oneof the nine “islands” surrounding Mount Meru in Bhū-maṇḍala. Bounded onits inner side by the Ocean of Salt and on its outer side by the Ocean of Liquor, it forms the second ring of land beyond Meru. It is ruled by Idhmajihva, a son of Priyavrata.",
  "polenta": "a yellow maize or cornmeal grown in northern Italy, where it is regarded as a staple food. Polenta is graded according to its texture and is availablefine-, medium-, or coarse-ground. It is available at most supermarkets and health food stores.",
  ...
  "Pracetās": "Tensons of Dakṣa who under the guidance of Lord Śiva performed severe austerities and meditation to help populate the universe.",
  ...
  "Pradyumna": "Ason of Kṛṣṇa in Dvāraka. He appears in Dvāraka and Mathurā as the transcendental Cupid, the third of the original quadruple vyūha expansions of the Supreme Lord. He again expands from Lord Nārayaṇa in Vaikuṇṭha, in the second quadruple, as the ruler of mind.",
  ...
  "Prahlāda Maharāja": "agreat devotee of Lord Kṛṣṇa who was persecuted by his atheistic father,Hiraṇyakaśipu, but was always protected by the Lord and ultimately saved by the Lord in the form of Nṛsiṁhadeva.",
  "Prahlāda": "Oneof the greatest devotees of Lord Viṣṇu. As the five-year-old son of themighty demon Hiraṇyakaśipu, he openly dared to worship the Personality of Godhead and preach His glories. Hiraṇyakaśipu tried many ways to killthe boy, but failed to harm him. Finally Lord Viṣṇu appeared as Lord Nṛsiṁha, killed Hiraṇyakaśipu, and enthroned Prahlāda as king of the demons.",
  "prajalpa": "Foolish, idle, or mundane speech. Talks unrelated to Kṛṣṇa consciousness.",
  "Prajāpatis": "The original “progenitors” ofthe universal population. They are the sons of Brahmā other than thecelibate Kumāras and Nārada.",
  ...
  "prākṛta-sahajiyā": "Aclass of pseudo-devotees who take the conjugal pastimes of Kṛṣṇa and the gopīscheaply and do not follow the proper regulations of vaidhi-bhakti.",
  "prākṛta-sahajiyās": "pseudodevotees of Kṛṣṇa who take devotional service cheaply and do not followthe regulations of the scripture; materialistic so-called Vaiṣṇavas whoimagine themselves to be confidential devotees.",
  ...
  "prāṇa": "Thevital air of life. It causes all movement in the body, physical and mental, and at death carries the soul into the next body.",
  ...
  "prarocanā": "themethod inducing the audience to become more and more eager to hear by praising the time and place, the hero and the audience.",
  "prasāda, or prasādam": "“themercy of Lord Kṛṣṇa.” Food prepared for the pleasure of Kṛṣṇa and offered to Him with love and devotion. Because Kṛṣṇa tastes the offering, the food becomes spiritualized and purifies anyone who eats it. See also: Mahā-prasādam",
  ...
  "Prativindhya": "Ason of Yudhiṣṭhira and Draupadī, murdered in his sleep with his brothers during the Battle of Kurukṣetra while they were still in their teens.",
  ...
  "Pretsila Hill": "a hill about 540 feet high, located five miles northwest of Gayā in the state of Bihar. Pilgrims perform the śraddha ceremonythere. A long flight of steps which leads to the summit and temple was constructed in 1774 by Ṭhākura Bhaktivinoda's ancestor Madan Mohan Dutt.",
  "preyas": "activity which is immediately beneficial but not ultimately auspicious.",
  "priyatama": "dearmost.",
  "Priyavrata": "Theeldest son of the first Manu, Svāyambhuva. He refused his father’s order that he marry and rule the earth, but Lord Brahmā convinced him tochange his mind. Priyavrata later gave charge of the dvīpas of Bhū-maṇḍala to seven of his sons, resumed his solitary practice of meditation, and at the end achieved liberation.",
  "proṣita-bhaṛtkā": "a woman whose husband has left home and gone to a foreign country.",
  "Pṛṣata": "the father of King Drupada.",
  "Pṛśni": "Kṛṣṇa’smother Devakī in an earlier life, when Kṛṣṇa appeared as Pṛśnigarbha. Even earlier, she appeared as Aditi, the mother of Lord Vāmana.",
  "Pṛthā": "See Kuntī.",
  ...
  "Puruṣa": "TheSupreme Lord in a Viṣṇu expansion for the creation of the material world; the enjoyer, or male, referring either to the living entity or the Supreme Lord.",
  ...
  "Puṣkara": "alake in western India dear to Lord Brahmā. At this place of pilgrimage is the only authorized temple of Lord Brahmā the world.",
  ...
  "Puṣpadanta": "aname for the Supreme Lord meaning “He whose teeth are as white as jasmine flowers.” Also, a devotee of Lord Śiva renowned for his poetic skill.",
  "Pūtanā": "Aninfanticidal witch who entered Vraja disguised as a beautiful woman andoffered the child Kṛṣṇa her poisoned breast milk, which He sucked out along with her life. Thus killed by Kṛṣṇa, Pūtanāwas elevated to Kṛṣṇa’seternal service in the mood of a mother.",
  ...
  "Rādhā-Dāmodara party": "Alarge group of ISKCON preachers who traveled throughout the United States during the 1970s, named for the presiding deities who traveled with them.",
  ...
  "rāgānuga-bhakti": "The stage of sādhana-bhaktiin which one’s practice of devotional service to Kṛṣṇa becomes spontaneous and follows in the mood of one of Kṛṣṇa’s eternal associatesin Vraja.",
  ...
  "Rāja-yoga": "Understandingof the form of the absolute within many forms, realized through the practice of the eightfold yoga system (ashtanga-yoga).",
  ...
  "rājasūya-yajña": "anelaborate sacrifice that establishes who is the emperor of the world. It was performed by Mahārāja Yudhiṣṭhira before the Battle of Kurukṣetraand attended by Lord Kṛṣṇa. (Sabhā Parva in Mahābhārata)",
  ...
  "Rāma-rājya": "aperfect, Vedic kingdom following the example of Lord Rāmacandra",
  "Rāmacandra": "theeighteenth incarnation of the Supreme Personality of Godhead, the killer of the tenheaded demon king, Rāvaṇa. Rāma was exiled to the forest on the order of His father, Mahārāja Daśaratha. His wife Sītā waskidnapped by Rāvaṇa, but by employing a huge army of monkeys, who were the powerful and intelligent offspring of demigods, He regained his wifein battle, and eventually His ancestral kingdom too. This great epic isrecounted in Vālmīki's Rāmāyaṇa.",
  ...
  "Ranaghat": "atown in the West Bengal district of Nadia just south of Navadvīpa on the railway to Calcutta. Ranaghat is the government headquarters of the Ranaghat subdivision of the Nadia district. It covers an area of about two-and-a-half square miles. Ṭhākura Bhaktivinoda's family lived here atdifferent times.",
  ...
  "Raṅganātha": "Thereclining deity of Viṣṇu residing near Tiruchchirapalli in Tamil Nadu. In the neighborhood of this temple Lord Caitanya Mahāprabhu stayed with Veṅkaṭa Bhaṭṭa and his family for four months.",
  "Rantideva": "Apious king who fasted forty-eight days and was then tested by demigods headed by Brahmā and Śiva. The demigods came in the guise of a brāhmaṇa, then a śūdra, and finally a caṇḍāla,each of whom begged portions of the food the king was to use to break his fast, finally leaving him without even water to drink. Because he tolerated all this, he received the blessings of the Supreme Lord.",
  "Rāsa Dance": "LordKṛṣṇa’s pleasure dance with the cowherd maidens of Vṛndāvana, Vrajabhūmi. It is a pure exchange of spiritual love between the Lord andHis most advanced, confidential servitors.",
  ...
  "rasam powder": "a South Indian spice blend used to flavour the famous rasam, a chili-hot soup dish made from toovar (arhar) dal lentils. Ingredients vary. The home-made rasampowder recipe contains mustard seeds, coriander seeds, dried hot red chilies, black peppercorns, fenugreek seeds, and cumin seeds. Rasam powder can be purchased ready-mixed in packets or tins from Indian grocery shops.",
  ...
  "Ratha-yātrā": "Theyearly festival in Purī during which Lord Jagannātha, His brother Lord Baladeva, and Their sister Subhadrā move in procession, each on their own cart, from their temple to the Gundicātemple, which represents Vṛndavana. Lord Caitanya Mahāprabhu would observe this Gundicā-yātrāwithgreat festivity in the company of His devotees.",
  "rati": "Attachment.",
  "raty-ābhāsa": "a preliminary glimpse of attachment.",
  "raudra-rasa": "one of the indirect relationships, anger.",
  "Rāvaṇa": "Thedemonic king of Laṅka who conquered the universe and abducted the wife of the Supreme Lord Rāma, who therefore invaded his kingdom and killed him.",
  ...
  "ricotta": "crumbly,soft white cheese made from the whey of cow's milk and popular in Italian cuisine. It is frequently used in cooking both sweet and savourydishes in Italy, for, like curd cheese or cottage cheese, its mild, somewhat bland flavour combines well with other ingredients. It is available at selected supermarkets or specialty grocers.",
  "rishi": "a sage.",
  ...
  "Romaharṣaṇa": "After dividing the original Veda into four, Vyāsadeva entrusted this disciple with the Purāṇasand epic histories. Later, in an assembly of sages at Naimiṣāraṇya, when Romahaṣaṇa failed to stand up from his speaker’s seat to honor LordBalarāma, Lord Balarāma killed him and installed Romaharṣaṇa’s son Ugraśravā (Sūta Gosvāmī) in his place.",
  ...
  "Rudra": "Lord Śiva.",
  "Rudra-sampradāya": "Oneof the four authorized Vaiṣṇava schools. It was founded originally by Lord Śiva and reestablished in the Kali-yuga by Śrī Viṣṇu Svāmī.",
  ...
  "Rukmī": "theson of King Bhīṣmaka, the King of Vidarbha, and the brother of Rukmiṇī,the first wife of Lord Kṛṣṇa. His hatred for Lord Kṛṣṇa eventually got him killed by Lord Baladeva during a chess game.",
  ...
  "Rukmini-Dvarakādhisa": "thetranscendental couple manifested as Kṛṣṇa, the Lord of Dvārakā, and Hisqueen Rukminī; name of the Deities of ISKCON Los Angeles.",
  "Rūpa Gosvāmī": "Oneof the six Gosvāmīs of Vṛndāvana, principal followers of Caitanya Mahāprabhu. Śrīla Rūpa is the prime authority on the science of rasa, loving exchanges with God, which he explained in his Bhakti-rasāmṛta-sindhu and Ujjvala-nīlamaṇi. He was also an eminent playwright and poet. Most Gauḍīya Vaiṣṇavas consider themselves rūpānugas, followers of Rūpa Gosvāmī.",
  ...
  "sādhana-bhakti": "Puredevotional service in practice, which purifies the heart and brings onetoward spontaneous loving service to the Supreme Lord.",
  ...
  "saffron": "the slender dried stigmas of the flowers of Crocus sativus,grown commercially in Spain, Kashmir, and China. When the plants bloom,the brilliant stigmas (the female organs of the plants are hand-picked daily, just as the plants open in the early morning. About 210,000 driedstigmas, picked from about 70,000 flowers yield one pound of saffron. Understandably, cost of saffron production is very high, and saffron is the world's most expensive spice. After picking, the saffron is dried insieves over low heat, then stored immediately. The final product is a compressed, highly aromatic matted mass of narrow, thread-like, dark-orange to reddish-brown strands about 2.5 cm (1-inch) long. Saffronhas a pleasantly spicy, pungent, slightly bitter honey-like taste with such a potent colouring power that one part of its colouring component, known as crocin, is capable of colouring up to 150,000 parts of water unmistakably yellow. Saffron has enjoyed immense popularity throughout the world for centuries. By the sixteenth century, for instance, saffronwas being extensively cultivated in England as a culinary spice. Its popularity today is limited to mainly Indian, French, Middle Eastern, and Spanish cuisines. The saffron strands should be soaked and ground orslightly dry-roasted and powdered before using. A big pinch of saffron is sufficient to colour a whole dish, but be sure to purchase the real thing--saffron is often adulterated. And remember, there is no such thing as cheap saffron! Saffron is available at Indian grocers, gourmet stores, and large Chinese medical centres, where it is known  as hoong fa (ask for the more expensive variety).",
  "sagar": "lake.",
  "sagarbha-yogī": "a yogī who worships the Supersoul in the Viṣṇu form.",
  "Saguṇa": "“possessingattributes or qualities.” In reference to the Supreme Lord, the term signifies that He has spiritual, transcendental qualities.",
  "Sahadeva": "Oneof the twin sons of Mādrī, who were the youngest of the five Pāṇḍavas. At Yudhiṣṭhira’s Rājasūya sacrifice, Sahadeva had the honor of proposingthat Kṛṣṇa be given the first worship.",
  ...
  "sahajiyās": "aclass of so-called devotees who, considering God cheap, ignore the scriptural injunctions and try to imitate the Lord’s pastimes; an offensive, immature devotee who does not follow proper devotional regulations.",
  ...
  "Śaibyā": "oneof the great archers on the side of the Pāṇḍavas during the Kurukṣetra war; one of the four horses that drove Lord Kṛṣṇa’s chariot; one of the wives of Lord Kṛṣṇa, after the Lord’s disappearance she entered fire andattained the spiritual world.",
  ...
  "śaktyāveśa-avatāra": "anempowered living entity who serves as an incarnation of the Lord; empowered by the Supreme Lord with one or more of the Lord’s opulences.",
  ...
  "Śala": "hewas one of the sons of Somadatta, a Kuru King. His brothers were Bhūri and Bhūriśravas. He was killed by Sātyaki during the Kurukṣetra war.",
  ...
  "Śalya": "theKing of Madras. His sister was Mādrī who was married to Pāṇḍu. He wanted to join the side of the Pāṇḍavas during the Kurukṣetra war, but was tricked by Duryodhana into offering him his services. He was killed by Yudhiṣṭhira during the Kurukṣetra war.",
  ...
  "sama-darśī": "seeingwith equal vision. Therefore, one who has knowledge of the soul and howthe soul transmigrates from one body to another does not pay attention to the body, which is nothing but a covering dress. Paṇḍitāḥ sama-darśinaḥ [Bg. 5.18]. Such a person sees the soul, which is part and parcel of the Supreme Lord. Therefore he is a sama-darśi, a learned person.",
  "samādhi": "1.Fully matured meditation, the last of the eight steps of the yoga system taught by Patañjali. A perfected devotee of the Supreme Lord alsoachieves the same samādhi. 2. The tomb of a pure devotee of the Lord.",
  "samana-vayu": "theinternal bodily air which adjusts equilibrium. It is one of the five bodily airs controlled by the breathing exercises of the aṣtanga-yoga system.",
  ...
  "saṁskāra": "one of the Vedic reformatory rituals performed one by one from thetime of conception until death for purifying a human being.",
  ...
  "Sanātana-dharma": "literally,the “eternal activity of the soul”, or the eternal religion of the living being–to render service to the Supreme Lord, which in this age isexecuted mainly by chanting the mahā-mantra. See also: Bhāgavata-dharma.",
  ...
  "Sāndīpani": "Asage residing in Avanti who was the teacher of Kṛṣṇa and Balarāma afterthey moved to Mathurā. They learned from him all the sixty-four traditional arts in sixty-four days.",
  "saṅga": "Association.",
  "saṅgam": "meeting point of two or more rivers.",
  "Sañjaya": "charioteerand minister to King Dhṛtarāṣṭra. Sañjaya narrated the events of the Kurukṣetra war to Dhṛtarāṣṭra by the mercy of Vyāsa; also a former king of the Ikṣvāku dynasty.",
  ...
  "Saṅkara": "see: Śiva",
  "Śaṅkarācārya": "anincarnation of Lord Śiva who appeared in South India at the end of the 7th century A.D. to re-establish the authority of the Vedic scriptures. He was a philosopher and lived about three hundred years before Rāmānuja. He did this at a time when India was under the sway of Buddhism, whose tenets deny the authority of the Vedas. He took sannyāsa ata very tender age and wrote commentaries establishing an impersonal philosophy similar to Buddhism, substituting Brahman (Spirit) for the void. He traveled all over India defeating the great scholars of the dayand converting them to his doctrine of Māyāvāda, the advaita (non-dualism) interpretation of the Upaniṣads and Vedānta. He left the world at the age of 33.",
  "Saṅkarṣaṇa": "Anothername of Lord Balarāma. Also, one of Lord Nārāyaṇa’s quadruple expansions in Vaikuṇṭha. Balarāma is the original Saṅkarṣaṇa, since Nārāyaṇa is Lord Balarāma’s expansion.",
  ...
  "sāṅkhya": "analyticaldiscrimination between spirit and matter and the path of devotional service as described by Lord Kapila, the son of Devahūti in the Śrīmad-Bhāgavatam; analytical understanding of the body and the soul. See also: Sāṅkhya-yoga",
  "sāṅkhya-yoga": "the process of linking with the Supreme by intellectually tracing out the source of creation.",
  "saṅkīrtana": "Congregationalchanting of the names and glories of Kṛṣṇa, which is the prime means for spiritual success in the current Age of Kali.",
  "saṅkīrtana-yajña": "thesacrifice prescribed for the Age of Kali, namely, congregational chanting of the name, fame and pastimes of the Supreme Personality of Godhead.",
  ...
  "Śantanu": "thefather of Bhīṣma by Gaṅgā. He gave Bhīṣma the benediction that he coulddie only when he wanted to. It was said that anything he touched with his two hands would become youthful.",
  "śānti": "Peace.",
  "Śāntipur": "avillage in the Ranaghat subdivision of the West Bengal district of Nadia. It is famous as the home of Śrī Advaita Ācārya, the associate of Lord Caitanya and incarnation of Mahā-Visṇu. It is close to Māyāpura.",
  "śāpa": "a brāhmaṇa’s curse.",
  "Sapta-dvīpa": "the seven islands of the earth.",
  "Sapta-suta": "theseven sons, namely hearing, chanting, remembering, offering prayers, serving the lotus feet of the Lord, worshiping the Deity and becoming a servant of the Lord.",
  ...
  "saralatā": "simplicity.",
  "sāram": "Essence.",
  "Śaraṇāgatī": "Theprocess of surrender; a collection of songs by Bhaktivinoda Ṭhākura; the name of an ISKCON farm in Ashcroft, British Columbia, Canada.",
  "Sarasvatī": "Thegoddess of learning. Also, one of India’s great sacred rivers. In the modern age the river is almost totally invisible, but a short stretch ofit appears from the Himalaya mountains, near Vyāsadeva’s āśrama, just north of Badarika. The Sarasvatī joins underground with the Gaṅga and Yamunā at Prayāga.",
  ...
  "Sārvabhauma Bhaṭṭācārya": "Aprominent scholar of Navya-nyāya logic and Vedānta who tried to instruct Lord Caitanya Mahāprabhu and then surrendered to Him. He is regarded as being in fact one of Lord Caitanya’s closest eternal associates.",
  ...
  "sāṣṭānga-pranāma (Daṇḍavat)": "arespectful obeisance executed by prostrating eight limbs of the body, namely the thighs, feet, hands, chest, thoughts or devotion, head, voice, and closed eyes.",
  ...
  "Satī": "thewife of Lord Śiva and the daughter of Dakṣa, who burned herself alive when her father insulted her husband; when a widow burns herself in her husband's cremation/funeral fire.",
  "Śatrughna": "Theyoungest of Lord Rāmacandra’s three brothers. He is an incarnation of Lord Aniruddha, one of the first four expansions of Lord Nārāyaṇa.",
  "sattva": "Goodness.",
  ...
  "sāttvika-bhāvas": "Inthe development of pure love of God, ecstasies that arise automatically, without conscious intention. They are eight in number.",
  ...
  "Satya-yuga": "Thefirst of four repeating ages that form the basic cycles of universal time. During its 1, 728,000 years, purity and spiritual competence are prominent.",
  ...
  "Sātyaki": "theson of Śini, and a prominent member of the Yadu dynasty. He was an intimate friend of Lord Kṛṣṇa and student of Arjuna. He fought during the Kurukṣetra war and killed many kings on the side of the Kauravas.",
  ...
  "Satyavatī": "thedaughter of the fisherman King. She was the mother of Vyāsadeva by Paraśara Muni. She later married Mahārāja Śantanu and begot two children, Citrāṅgada and Vicitravīrya.",
  ...
  "Saubha": "theairship of King Śālva. It was created by the demon Maya, and Śālva usedthis airship to attack Dvārakā. It was destroyed by Lord Kṛṣṇa.",
  "Saubhari Muni": "a powerful mystic who accidentally fell down to sex attraction.",
  "Saubhari": "Asage who while meditating under the water of the Yamunāsaw a pair of fish mating and became sexually aroused. He then approached King Mandhātā and begged from him the hand of his fifty daughters. After enjoying family life for some time, he revived his interest in renunciation.",
  "sauhṛdya": "endeavor.",
  ...
  "Śibi": "Apious king who was tested by the demigods Indra and Agni, disguised as ahawk and a pigeon. To save the life of the pigeon, Mahārāja Śibi allowed his own flesh to be eaten by the hawk. The two demigods then revealed their identities and blessed Śibi.",
  "sichuan peppercorns": "the dried red berries of the small, feathery-leaved, spiny tree Xanthoxylum piperitum,grown in Sichuan province of South Eastern China. Sichuan peppercorns have a pungent smell, but only a faintly hot taste, and are an importantingredient in Chinese five-spice powder.",
  ...
  "Siddhas": "Aclass of celestial beings advanced in spiritual discipline and naturally possessed of the eight mystic powers, such as the abilities tobecome atomic in size and to control other people’s minds.",
  "siddhi": "Perfection; one of the eight mystic yogic perfections.",
  "siddhi-kāṇḍa": "see: Jñāna-kāṇḍa.",
  ...
  "Sītā-Rāma": "thetranscendental couple manifested as Lord Rāmacandra, Kṛṣṇa’s incarnation as the perfect king, and Lord Rāma’s eternal consort, Sītā.",
  ...
  "Six Gosvāmīs": "Six great disciples of LordCaitanya who wrote many books on devotional service and established themajor temples in Vṛndāvana.",
  ...
  "smarta": "the popular name for followers of the Vedaswho are overly attached to elevation and salvation. They are very careful about the latter, but often not the spirit, of scriptural injunctions, confounding the mundane with the spiritual. They are very fond of the smṛti-śāstras and are thus known as smartas.",
  ...
  "snowpeas": "the young, sweet pea pods of Pisum saccaIatum, also called mange-toutin France. This delicately flavoured vegetable is a versatile cooking ingredient, especially in Chinese cooking, where it is stir-fried quickly to retain its flavour and colour. The pods should have their tops removed and their strings pulled away before use. They're availableat Chinese grocers and supermarkets.",
  "soma": "Thejuice of a sacred plant, offered in the more elaborate Vedic sacrificesto the principal demigods. The performers of these sacrifices who are entitled to drink the soma juice gain elevation to heaven.",
  ...
  "Somadatta": "theson of King Bālhīka and the grandson of King Pratīpa. He had three sonsname Bhūri, Bhūriśravas, and Śala. He was killed by Sātyaki during the battle of Kurukṣetra.",
  ...
  "split peas": "skinnedand split, green or yellow dried peas. The green ones are especially good for cooking to a creamy puree. Yellow split peas can replace toovar or chana dal in a recipe. They are available at all supermarkets and grocery stores.",
  ...
  "Śrīla Prabhupāda": "His Divine Grace A. C.Bhaktivedanta Swami Prabhupāda, the founder-ācārya of the InternationalSociety for Kṛṣṇa Consciousness.",
  ...
  "Srīvāsa Ṭhākura": "theincarnation of Śri Nārada Muni in Lord Caitanya's pastimes. An intimateassociate of Lord Caitanya. His courtyard served as the birthplace of Lord Caitanya's saṅkīrtana movement, and his altar was the site of the mahā-prakāśa pastime (twenty-one hours of ecstatic manifestation) of Śrī Caitanya.",
  "Śrīvatsa": "Acurl of white hair on the chest of Lord Viṣṇu that represents the goddess of fortune and distinguishes Him from His liberated devotees whohave attained sārūpya.",
  ...
  "Srutakarmā": "theson of Sahadeva by Draupadī. He fought in the battle of Kurukṣetra and was killed by Aśvatthāmā while rising from sleep in his tent.",
  "Srutakīrti": "ason of Arjuna by Draupadī. He fought in the battle of Kurukṣetra and was killed by Aśvatthāmā while rising from sleep in his tent.",
  "Śrutāyudha": "aking of Kaliṅga. He was the son of Varuṇa by Parṇāśā. He died on the battlefield of Kurukṣetra when he released his mace at Lord Śrī Kṛṣṇa. His mace could not be thrown at one who was not engaged in combat or it would come back and kill the one who threw it. Since Lord Kṛṣṇa was not engaged in combat, the mace came back and killed Śrutāyudha.",
  "śruti": "“What has been heard,” the original Vedas,meant to be passed on orally from generation to generation without change. They are considered coexistent with the Supreme Lord Himself andso in need of no author.",
  "Śruti-gaṇa": "the personified Vedas.",
  "Śruti-mantras": "the hymns of the Vedas.",
  "śruti-phala": "Lit.,“the fruit of hearing.” A benediction of material or spiritual success given as a result of faithfully hearing various pastimes of the Lord andHis devotees.",
  ...
  "Subhadrā": "Kṛṣṇa’ssister, also known as Yogamāyā. She is Kṛṣṇa’s internal energy who arranges His pastimes and fosters spontaneous love for Him by making Hisintimate devotees forget He is God.",
  "Subrahmaṇya": "Kārtikeya, the son of Lord Śiva. The god of war. Also known as Skanda.",
  "Sudakshiṇa": "Ason of the king of Kāśī. After Kṛṣṇa killed that king, Sudakṣiṇa performed a fire sacrifice to unleash a demon to kill Kṛṣṇa. But the demon failed in that mission, returned to Kāśī, killed Sudakṣiṇa, and burned his city to the ground.",
  ...
  "Sudāma Brāhmaṇa": "Aschool classmate of Kṛṣṇa’s who later, being impoverished, visited Kṛṣṇa in Dvāraka to ask for aid. But he asked Him for nothing, and yet returned home to find his hut transformed into a palace.",
  ...
  "Sugrīva": "The king of Kiṣkindha, a kingdomof monkeys. He and his monkey army helped Lord Rāma invade Laṅkā anddefeat the demon Rāvaṇa.",
  ...
  "Sulocana": "oneof the one hundred sons of Dhṛtarāṣṭra. He was killed by Bhīma during the battle of Kurukṣetra. (Bhīṣma Parva in Mahābhārata)",
  "sumac": "an important souring agent in Arab cuisine. The seeds of Rhus corioriaare ground to a purple-red powder and used to add a sour, pleasantly astringent taste to recipes as a preferred substitute for lemon. The extracted juice of the soaked seeds is used in salads and in some vegetable dishes to impart a tamarind-like flavour. Sumac has a pleasant, rounded, fruity sourness which is well worth experimenting with. It is available at Middle Eastern grocers.",
  "sumanaḥ flowers": "Flowers of Feronia elephantum, the wood apple; dull red or greenish flowers born in panicles.",
  "Sumeru": "Thegreat mountain that is the axis of the universe. It is also called Meruand Mahāmeru. It extends upward through the center of the earthly planetary system, and on its upper peak lies Satyaloka, the abode of Lord Brahmā.",
  "Sunābha": "oneof the one hundred sons of Dhṛtarāṣṭra. He was killed by Bhīma during the battle of Kurukṣetra. (Bhīṣma Parva in Mahābhārata)",
  "Sunanda": "one of the chief personal servants of Lord Nārāyaṇa in His spiritual abode, Vaikuṇṭha.",
  "Sundara-ārati": "Eveningworship of the Deity in the temple. Supersoul an expansion of the Supreme Lord as an all-pervading personal presence in the universe and in the heart of every living entity.",
  ...
  "Śūrasena": "Agreat Yādava king, father of Vasudeva and Kuntī. The province of ūrasenā, which includes the Mathurā district, is named after him.",
  ...
  "Sūta Gosvāmī": "theson of Romaharsaṇa. He was the great sage who related the discourse between Parīkṣit Mahārāja and Śukadeva Gosvāmī, which forms the basis ofthe Śrīmad-Bhāgavatam. See also: Naimiṣāraṇya",
  "Suta": "theson of Vaidarbhī, or, in other words, one who is somewhat advanced in fruitive activities and who comes in contact with a devotee spiritual master. Such a person becomes interested in the subject matter of devotional service.",
  ...
  "Sutapā": "Thehusband of Pṛśni and father of the Supreme Lord’s incarnation Pṛśnigarbha. Sutapā in his previous life had been Kaśyapa, the father ofLord Vāmana, and after his life as Sutapā he became Vasudeva, Kṛṣṇa’s father.",
  "Sutasoma": "theson of Bhīmasena and Draupadī. He was killed by Aśvatthāmā while awaking from sleep on the last night of the Kurukṣetra war.",
  ...
  "Syāmānanda Gosvāmī (1535-1631)": "one of the great Vaiṣṇava ācāryaswho lived in Vṛndāvana after the time of Śrī Caitanya. He received the direct mercy of Rādhārāṇī in Vṛndāvana, was tutored in the bhakti-śāstras byJīva Gosvāmī and delivered countless souls, especially in Orissa. He was initiated by Hṛdāya Caitanya dāsa and got the name Duḥkhi Kṛṣṇadāsa,but later he was called Syāmānanda by Jīva Gosvāmī, who noted his attraction for the Deity Śyāmāsundara.",
  "Syamantaka": "Ajewel able to produce heaps of gold and assure prosperity and good health. The sun-god gave it to his devotee Satrājit, who lost it and suffered misfortune after refusing Kṛṣṇa’s request to place it in the care of King Ugrasena. Kṛṣṇa eventually recovered the jewel and returnedit to Satrājit, who offered it to Kṛṣṇa along with his daughter Satyabhāmā.",
  ...
  "tahini": "asemi-liquid sesame butter used in Middle Eastern cuisine. This cream-gray paste has the consistency of runny peanut butter and is the basis of various salad dressings and mezze (entrees) throughout Greece, Cyprus, Lebanon, Jordan, and Syria where it is known as tahina.",
  "Takṣaka": "Awinged snake who was protected by his friend Indra from the conflagration of the Khāṇḍava forest and who later, by the curse of Śṛṅgi, was fated to kill Mahārāja Parīkṣit. Kaśyapa Muni tried to stop Takṣaka from approaching Parīkṣit, but Takṣaka managed to carry out his mission by bribing the sage.",
  "takuwan": "Japanese white daikon radish, pickled in rice bran and salt.",
  "tamāla": "Garcinia xanthochymus, cinnamomum tamala,a tree with blackish blue bark resembling the color of Kṛṣṇa. It is sacred to Vaiṣṇavas and is featured in many of the pastimes of Kṛṣṇa andHis associates.",
  "tamarillo": "sometimescalled the tree tomato, this glossy plum-red egg-shaped fruit is a native to South America and the Peruvian Andes. It is now grown commercially in New Zealand. Tamarillos have a juicy, slightly acid flesh, and can be used raw, after peeling, for fruit salads or cooked inpurees and chutneys. It is available at selected produce markets and greengrocers.",
  "tamarind": "the pulp extracted from the brown pods of the tamarind tree, Tamarindus indica.The fresh pulp has a sour fruity taste and is popular in Indian and Indonesian cooking. Tamarind is available in different forms commercially. The crudest consists of blocks of partly dried, unpitted, broken, sticky, fibrous pods. They should be macerated in water to extract the sour brown tamarind juice, as should another form, in blocksof fibrous pulp without seeds. The most convenient is tamarind concentrate, which can be used straight from the jar. Tamarind makes excellent sweet-and-sour chutneys or sauces, and can be used in vegetable dishes and curries. Tamarind in its various forms is availableat Indian and South East Asian grocery stores.",
  ...
  "Tapas": "(Tapoloka) The planet of renouncedsages, above Svarga, Jana, and Mahar, where exalted persons such as thefour Kumāras reside.",
  ...
  "tattva-jñāna": "“Scientific knowledge” of one’s relationship with the Supreme, the means of reviving that relationship, and the perfection achieved by thatmeans.",
  ...
  "Ṭhākura Haridāsa": "see: Haridāsa Ṭhākura",
  ...
  "thyme": "thisattractive herb is grown in Mediterranean regions and Asia Minor. Thereare more than one hundred species of thyme, but common or garden thyme,Thymus vulgaris, is frequently used. Others include lemon, mint,orange, golden-lemon, caraway-scented, woolly-stemmed, and the silver thyme. Used fresh or dried, thyme imparts a distinctively warm, pleasant, aromatic flavour and is popular as one of the great European culinary herbs. It is used alongside bay and parsley in bouquet gami,and goes into many soups and vegetable dishes (especially potatoes, zucchini, eggplants, and sweet peppers). It is available fresh at selected greengrocers and dried at grocery stores and supermarkets.",
  "ṭīkā": "Commentary.",
  "tilaka": "Auspiciousmarks, of sacred clay and other substances, applied daily on the forehead (and sometimes on various limbs as well) to dedicate one’s bodyto God.",
  "timiṅgila": "a huge aquatic monster that can swallow whales.",
  "Tīrtha (teertha)": "asacred place of pilgrimage associated with a pastime of an incarnation of God, such as a holy river, a temple of the Lord, or the residence or place of meditation of a holy sage or saintly person.",
  ...
  "Tripura": "Threeflying cities built by Maya Dānava for the three sons of the demon Tāraka. These aerial fortresses rendered the enemies of the demigods invincible, until the secret was discovered that Lord Śiva could destroythe cities with a single arrow at the rare moment when they conjoined in a straight line.",
  ...
  "Tulādhāra": "Asaintly businessman of ancient Kāśī who taught religious principles to the sage Jājali, earning them both entry into Vaikuṇṭha.",
  ...
  "Urvaśī": "oneof the heavenly Apsarās. She tried to seduce Arjuna when he was in the heavenly kingdom. Arjuna refused to satisfy her because he considered her the mother of the Kuru dynasty having taken Puru for her husband. Because of Arjuna’s refusal, Urvaśī cursed Arjuna to become a eunuch forone year. This curse took its effect during last year of exile of the Pāṇḍavas in the kingdom of Virāṭa; a woman from the heavenly planets whobecame enamored of King Purūravā.",
  "Ūrdhva-retasaḥ": "'ūrdhva=upwards','retasa=semen' - The semen flowing upwards, meaning those in thecelibasy who are completely detached from sex. - SB 4.8.1 PURPORT: 'Thesystem of brahmacarya has been current since the birth of Brahmā. Asection of the population, especially male, did not marry at all.Instead of allowing their semen to be driven downwards, they used tolift the semen up to the brain. They are called ūrdhva-retasaḥ, thosewho lift up. Semen is so important that if, by the yogic process, onecan lift the semen up to the brain, he can perform wonderful work",
  ...
  "Uttamaujas": "aprince of Pāñcāla, and a valiant warrior during the Kurukṣetra battle. He was killed by Aśvatthāmā while in his bed during the last night of the Kurukṣetra war.",
  "Uttānapāda": "the king who was a son of Svāyambhuva Manu and the father of Dhruva Mahārāja.",
  "Uttarā": "KingVirāṭa’s daughter, the wife of Arjuna’s son Abhimanyu. Kṛṣṇa entered her womb to save her son, Parīkāit, the last heir to the Kuru throne.",
  "Uttara": "ason of King Virāṭa. He was afraid to confront the Kurus when they stolethe cows from his father’s kingdom. Arjuna revealed his disguise to this prince and then single-handedly fought with the Kauravas and defeated them all. Uttara was killed in the first day’s fighting at Kurukṣetra by Śalya.",
  ...
  "vaijayantī": "Aspecial garland worn by the Supreme Lord. It is made from flowers of atleast five different colors, and it hangs down at least to His knees.",
  ...
  "Vaiśeṣikā": "see: Kaṇāda.",
  "Vaiṣṇava": "Adevotee of the Supreme Lord Viṣṇu. Since Kṛṣṇa and Viṣṇu are different aspects of the same Supreme Person, devotees of Kṛṣṇa are also Vaiṣṇavas.",
  ...
  "Vaivasvata-manvantara": "Thepresent period of cyclical universal time, ruled over by Vaivasvata Manu. During the lifetime of Lord Brahmā, which corresponds to the duration of the universe, there are 504,000 Manus.",
  "Vaiyāsaki": "see: Śukadeva Gosvāmī",
  ...
  "Vālmīki": "Thesage who composed the great epic history of Lord Rāmacandra’s life. At first a vicious criminal, Vālmīki became purified by unintentionally chanting the name Rāma.",
  ...
  "Vāmana": "(-deva) Lord Viṣṇu’s form as a young brāhmaṇa boy, one of the daśa-avatāras,the ten most famous incarnations of the Lord. After begging three stepsof land from Bali Daityarāja, Vāmanadeva covered with His first two steps the entire universe, and for the third step Bali offered his own head. Pleased with Bali’s surrender, Lord Vāmana offered to become the guard at Bali’s door.",
  ...
  "vana": "forest.",
  "vānaprastha": "A man or woman in the retired order of life, the third stage of spiritual progress in the varṇāśramasocial system. In this order a married man leaves home and travels to the forest and holy places of pilgrimage, either with or without his wife, to prepare himself for full renunciation, sannyāsa.",
  ...
  "Vārāṇasī": "oneof the oldest and most famous places of pilgrimage in India; also knownas Kāśī and Benares. It is a center of impersonalistic, or Māyāvāda, philosophy. Here is where Lord Caitanya defeated Prakāśānanda Sarasvati,the leading Māyāvādī of his day.",
  ...
  "varṇāśrama-dharma": "thesystem of four social and four spiritual orders established in the Vedic scriptures and discussed by Śrī Kṛṣṇa in the Bhagavad-gītā.",
  ...
  "vāsīs": "Residents.",
  "Vasiṣṭha": "Agreat sage, one of the mind-born sons of Brahmā, reborn in a later age as a son of Mitra and Varuṇa. He served as priest for Lord Rāmacandra, Indra, Vaivasvata Manu, Ambarīṣa, Hariścandra, Yudhiṣṭhira, and others.",
  ...
  "Vasudeva": "thefather of Kṛṣṇa, and the half-brother of Nanda Mahārāja; the state of pure goodness, which transcends the material modes of nature and in which one can understand the Supreme Lord.",
  ...
  "Vibhīṣaṇa": "Thesaintly brother of Rāvaṇa who abandoned Rāvaṇa to join the side of LordRāma. After Rāvaṇa’s death, Vibhīṣaṇa was crowned king of Laṅkā.",
  "vibhu": "Great.",
  "Vibhu-ātmā": "the Supersoul.",
  "vibhūti": "asecondary incarnation indirectly empowered by the Supreme Lord; opulence by which Kṛṣṇa controls the entire material manifestation.",
  ...
  "Vidura": "ThePāṇḍavas’ uncle who was the son of Dvaipāyana Vyāsa by the maidservant of the deceased Vicitravīrya. Vidura was an incarnation of Yama, who hadbeen cursed to be born a śūdra.",
  "vidūra-vigata": "see: Caṇḍāla",
  "Viduratha": "Anenemy of Kṛṣṇa’s who attacked Kṛṣṇa to avenge the death of his brother Dantavakra but was quickly felled by the Lord’s Sudarśana disc.",
  "vidyā": "knowledge.",
  ...
  "vijaya-vigraha": "Deityforms which are taken out of the temple for processions and other outdoor functions, generally because of their smaller, more manageable size.",
  ...
  "Vikarṇa": "oneof the one hundred sons of Dhṛtarāṣṭra. He was the only one to stand upin defense of Draupadī during the gambling match. He was killed by Bhīma during the battle of Kurukṣetra. (Droṇa Parva in Mahābhārata)",
  ...
  "Vinda": "aprince of Avanti. He was the bother of Mitravindā, a queen of Lord Kṛṣṇa. He was very envious of Lord Kṛṣṇa and Arjuna. He was killed alongwith his brother Anuvinda during the Kurukṣetra war. Both brothers werekilled by Arjuna.",
  ...
  "Virāṭa": "Thekingdom where the Pāṇḍavas spent the last years of their exile incognito. Also, the name of its king. King Virāṭa’s daughter, Uttarā, became the wife of Arjuna’s son Abhimanyu and the mother of Parīkṣit.",
  "Virocana": "Ason of Prahlada and the father of Bali. Virocana, though a demon, diligently performed Vedic sacrifices and was famous for his charity to brāhmaṇas.",
  ...
  "Viṣṇudūtas": "themessengers of Lord Viṣṇu who come to take perfected devotees back to the spiritual world at the time of death, the personal servants of Lord Viṣṇu, they closely resemble If Him in appearance.",
  ...
  "Viśrāma-ghāṭa": "(Viśrānti-tīrtha) The main bathing ghāṭain the city of Mathurā on the river Yamunā. It is famous for being the place where Lord Varāha rested after killing the first demon in the universe, Hiraṇyakṣa.",
  "Visrama-ghata": "After Varaha killed Hiranyaksa, He spoke the Adi-varaha-Puranato mother Bhumi (Earth) while relaxing at Visrama-ghata. Thousands of years He rested here after killing Kamsa and dragging his body to shoresof the Yamuna.",
  ...
  "Viśvambhara": "onewho maintains the entire universe and who leads all living beings; the name of Lord Caitanya before He entered the renounced order.",
  "Viśvāmitra": "A king in the dynasty of the moon-god who, inspired by rivalry with Vasiṣṭha, became a renounced sage.",
  "Viśvanātha Cakravartī Ṭhākura": "a great ācārya in the Caitanya school of Vaiṣṇavism and the most prominent ācārya afterNarottama dāsa Ṭhākura. On the order of his guru he went to Vṛndāvana and by his life's end he had composed twenty-four valuable books on the science of bhakti. He established the Gokulānanda Temple. In his final years he lived at Rādhā-kuṇḍa; he has written commentaries on Śrīmad-Bhāgavatam and Śrīmad Bhagavad-gītā.",
  ...
  "Viśvarūpa": "1.A son of the demigod Tvaṣṭā. To win power to defeat the demons led by Vṛtra, the demigods took Viśvarūpa as their priest. But because he had asecret affinity for the demons and offered them oblations in sacrifice,Indra beheaded him. 2. The elder brother of Lord Caitanya Mahāprabhu.",
  ...
  "vivarta-vāda": "theerroneous concept; propounded by Śaṅkarācārya, that God is no longer complete after He expands His energies for creation; the Māyāvādī interpretation of the Vedānta-sūtra that the Supreme Lord becomes changed when He expands and that all manifest varieties are unreal.",
  "Vivasvān": "Thecurrent sun-god. His children include Yamarāja, the river Yamunā, Vaivasvata Manu, and Śanaiścara (the ruler of the planet Saturn).",
  ...
  "Vṛka": "(-asura)A demon to whom Lord Śiva granted the boon that any head he touched would at once break to pieces. When Vṛka wanted to try the boon on Lord Śiva, Lord Viṣṇu came in disguise and tricked Vṛka into touching his ownhead.",
  "Vṛkodara": "a name for Bhīmasena meaning “he of the voracious appetite.”",
  "Vṛndā": "(-devī) A principal gopī, a direct expansion of Śrīmati Rādhārāṇī. She is the presiding deity of Vṛndāvana forest, and the tulasīplant is her expansion. She and grandmother Paurṇamāsī make all the behind-the-scenes arrangements for Rādhā and Kṛṣṇa’s daily pastimes.",
  ...
  "Vṛṣasena": "theson of Karṇa. He was considered a Mahārathi. He was killed by Arjuna inthe presence of his father Karṇa. (Karṇa Parva in Mahābhārata)",
  ...
  "Vyāsadeva (Vyāsa)": "theliterary incarnation of God, and the greatest philosopher of ancient times. The son of Parāśara, and the compiler of the original Vedic scriptures, including the eighteen Purāṇas, Vedānta-sūtra, the Mahābhārata, and the Upaniṣads.He played a very important part in guiding the Pāṇḍavas during crucial times. He gave the vision of the battle of Kurukṣetra to Sañjaya so thathe could relate it to Dhṛtarāṣṭra. He is still living in this world.",
  ...
  "water chestnuts": "freshwater chestnuts, with their crunchy, succulent texture and sweet, nuttytaste, are a common delicacy in Asian cuisine. They are actually the edible root of an aquatic plant. The fresh water-chestnut has a tight skin; it should be peeled and sliced as required. If unavailable at goodChinese produce markets, tinned sliced water chestnuts sold at Chinese grocery stores are an acceptable (though inferior-tasting) substitute.",
  "whey": "theliquid by-product when milk is curdled in the curd-cheese-making process, or from yogurt when it is allowed to drain in a cheesecloth. Itcan be used in bread-making, in soups, or to cook vegetables. Allowed to sour, it can be used as an agent to curdle further batches of milk.",
  "Yādava dynasty": "see: Yadu dynasty below.",
  ...
  "yajña": "aVedic sacrifice; also, a name for the Supreme Lord meaning “the personification of sacrifice”; the goal and enjoyer of all sacrifices.",
  ...
  "Yakṣas": "Amilitant class of celestial beings, obedient to the treasurer of the demigods, Kuvera. Although frequently grouped with the man-eating Rākṣasas, they are also called the puṇya-janas ( “righteous persons”).",
  ...
  "Yamarāja": "thedemigod of death, who passes judgment on non-devotees at the time of death. He is the son of the sun-god and the brother of the sacred river Yamunā.",
  "yamas": "The first eight regulations observed from the beginning of the aṣṭāṅga-yoga system.",
  "Yamunā": "thesacred river where Kṛṣṇa performed many pastimes. One of the holy rivers of India, flowing through Vṛndāvana. It was here that Lord Śrī Kṛṣṇa sported when He was a young child. The personification of the Yamunā River, known as Kālindī, is the daughter of the sun god and the sister of Yamarāja, the god of death. She is also called Yamī. In Krṣṇa-līlā she became one of Krṣṇa's queens at Dvārakā.",
  ...
  "yeast": "yeastused for baking commonly comes in two forms",
  ...
  "yogurt": "thisversatile and healthful cultured dairy product is a staple food found in many cuisines of the world. Its pleasantly tangy flavour and smooth, refreshing texture give it great appeal.",
  "yojana": "a standard Vedic measurement equal to eight miles.",
  "yuddha": "the Sanskrit word for war.",
  "Yudhāmanyu": "aprince of Pāñcāla. He fought on the side of the Pāṇḍavas and was killedon the last night of the battle when Aśvatthāmā entered his tent severed his head.",
  "Yudhiṣṭhira": "the eldest of the Pāṇḍavas in the Mahābhārata, and the son of Dharmarāja or Yamarāja, the god of death. It was the dispute over his succession to the throne in India that led to the Battle of Kurukṣetra; he ruled the earth after theKurukṣetra war.",
  ...
  "Yuyutsu": "ason of Dhṛtarāṣṭra by a Vaiśya wife. He took the side of the Pāṇḍavas during the Kurukṣetra war. He lived through the battle and performed thelast funeral rites for the slain warriors on the side of the Kurus.",
